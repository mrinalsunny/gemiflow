...
**Status**: HIGH, open. Tracked at https://github.com/mrinalsunny/gemiflow/issues/2047.
...
**Status**: FIXED upstream + downstream integrated. Tracked at https://github.com/mrinalsunny/gemiflow/issues/2048.
...
- Bumped `agentic-flow` ^2.0.12 → ^2.0.13 in root `package.json` and `v3/@gemiflow/browser/package.json`.
- Regenerated root `package-lock.json`, `v3/@gemiflow/browser/package-lock.json` (npm `--no-workspaces`), and `v3/pnpm-lock.yaml`.
