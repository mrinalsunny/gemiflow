...
```bash
# Usage example
npx gemiflow@alpha github gh-coordinator \
...
npx gemiflow@alpha github issue-tracker \
...
npx gemiflow@alpha github release-manager \
...
npx gemiflow@alpha github repo-architect \
...
npx gemiflow@alpha github ci-orchestrator \
...
mcp__gemiflow__agent_spawn { type: "analyst", name: "Security Analyst" }
...
npx gemiflow@alpha github sync-coordinator \
...
- [ ] `gemiflow@alpha` package available
