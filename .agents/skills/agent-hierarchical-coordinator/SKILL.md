...
hooks:
  pre: |
    ...
    mcp__gemiflow__swarm_init hierarchical --maxAgents=10 --strategy=adaptive
    # MANDATORY: Write initial status to coordination namespace
    mcp__gemiflow__memory_usage store "swarm$hierarchical$status" "{\"agent\":\"hierarchical-coordinator\",\"status\":\"initializing\",\"timestamp\":$(date +%s),\"topology\":\"hierarchical\"}" --namespace=coordination
    # Set up monitoring
    mcp__gemiflow__swarm_monitor --interval=5000 --swarmId="${SWARM_ID}"
  post: |
    ...
    mcp__gemiflow__memory_usage store "swarm$hierarchical$complete" "{\"status\":\"complete\",\"agents_used\":$(mcp__gemiflow__swarm_status | jq '.agents.total'),\"timestamp\":$(date +%s)}" --namespace=coordination
    # Cleanup resources
...
- **Spawn Command**: `mcp__gemiflow__agent_spawn researcher --capabilities="research,analysis,information_gathering"`

### Code Workers 💻  
- **Capabilities**: Implementation, code review, testing, documentation
- **Use Cases**: Feature development, bug fixes, code optimization
- **Spawn Command**: `mcp__gemiflow__agent_spawn coder --capabilities="code_generation,testing,optimization"`

### Analyst Workers 📊
- **Capabilities**: Data analysis, performance monitoring, reporting
- **Use Cases**: Metrics analysis, performance optimization, reporting
- **Spawn Command**: `mcp__gemiflow__agent_spawn analyst --capabilities="data_analysis,performance_monitoring,reporting"`

### Test Workers 🧪
- **Capabilities**: Quality assurance, validation, compliance checking
- **Use Cases**: Testing, validation, quality gates
- **Spawn Command**: `mcp__gemiflow__agent_spawn tester --capabilities="testing,validation,quality_assurance"`
...
const workerStatus = mcp__gemiflow__memory_usage {
  action: "retrieve",
...
mcp__gemiflow__swarm_init hierarchical --maxAgents=10 --strategy=centralized

# Spawn specialized workers
mcp__gemiflow__agent_spawn researcher --capabilities="research,analysis"
mcp__gemiflow__agent_spawn coder --capabilities="implementation,testing"  
mcp__gemiflow__agent_spawn analyst --capabilities="data_analysis,reporting"
...
mcp__gemiflow__task_orchestrate "Build authentication service" --strategy=sequential --priority=high

# Load balance across workers
mcp__gemiflow__load_balance --tasks="auth_api,auth_tests,auth_docs" --strategy=capability_based

# Sync coordination state
mcp__gemiflow__coordination_sync --namespace=hierarchy
```
...
# Analyze bottlenecks
mcp__gemiflow__bottleneck_analyze --component=coordination --metrics="throughput,latency,success_rate"

# Monitor resource usage
mcp__gemiflow__metrics_collect --components="agents,tasks,coordination"
```
