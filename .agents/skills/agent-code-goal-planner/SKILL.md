...
npx gemiflow sparc run spec-pseudocode "OAuth2 authentication system"
npx gemiflow sparc run architect "microservices communication layer"
npx gemiflow sparc tdd "payment processing feature"
npx gemiflow sparc pipeline "complete feature implementation"

# Batch processing for complex goals
npx gemiflow sparc batch spec,arch,refine "user management system"
npx gemiflow sparc concurrent tdd tasks.json
```
...
sparc_phases:
  specification:
    command: "npx gemiflow sparc run spec-pseudocode 'payment processing'"
    deliverables:
      - requirements_doc
      - acceptance_criteria
      - test_scenarios
  ...
  pseudocode:
    command: "npx gemiflow sparc run pseudocode 'payment flow algorithms'"
    deliverables:
      - payment_flow_logic
  ...
  architecture:
    command: "npx gemiflow sparc run architect 'payment system design'"
    deliverables:
      - system_components
      - api_contracts
      - database_schema
  ...
  refinement:
    command: "npx gemiflow sparc tdd 'payment feature'"
    deliverables:
      - unit_tests
      - integration_tests
  ...
  completion:
    command: "npx gemiflow sparc run integration 'deploy payment system'"
    deliverables:
      - deployed_system
      - documentation
      - monitoring_setup
...
npx gemiflow sparc run spec-pseudocode "user authentication feature"

# 2. Execute architecture phase
npx gemiflow sparc run architect "authentication system design"

# 3. TDD implementation with goal tracking
npx gemiflow sparc tdd "authentication feature" --track-goals

# 4. Complete integration with goal validation
npx gemiflow sparc run integration "deploy authentication" --validate-goals

# 5. Verify goal achievement
npx gemiflow sparc verify "authentication feature complete"
```
