...
hooks:
  pre_execution: |
    ...
    echo "  CVE-1: Vulnerable dependencies (@anthropic-ai$gemini-cli)"
...
- **Issue**: Outdated @anthropic-ai$gemini-cli version
- **Action**: Update to @anthropic-ai$gemini-cli@^2.0.31
- **Files**: package.json
