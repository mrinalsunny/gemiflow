...
description: "CLI modernization and hooks system enhancement for gemiflow v3. Implements interactive prompts, command decomposition, enhanced hooks integration, and intelligent workflow automation."
---
...
Modernizes gemiflow v3 CLI with interactive prompts, intelligent command decomposition, enhanced hooks integration, performance optimization, and comprehensive workflow automation capabilities.
...
gemiflow swarm init --interactive
gemiflow learning start --guided
gemiflow workflow create --from-intent "setup new project"
```