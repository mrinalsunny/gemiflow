...
tools: mcp__gemiflow__swarm_init, mcp__gemiflow__agent_spawn, mcp__gemiflow__task_orchestrate, mcp__gemiflow__memory_usage, Bash, TodoWrite, Read, Write
color: green
type: development
capabilities:
...
mcp__github__create_issue {
  owner: "mrinalsunny",
  repo: "ruv-FANN",
  title: "Integration Review: gemiflow and ruv-swarm complete integration",
...
[Single Message - Issue Lifecycle Management]:
  ...
  mcp__gemiflow__agent_spawn { type: "coordinator", name: "Issue Manager" }
  mcp__gemiflow__agent_spawn { type: "analyst", name: "Progress Tracker" }
  mcp__gemiflow__agent_spawn { type: "researcher", name: "Context Gatherer" }
  ...
  Bash(`gh issue create \
    ...
    --body "Resolve merge conflicts in integration$gemiflow-ruv-swarm..." \
