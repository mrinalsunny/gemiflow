...
npx gemiflow benchmark-run --suite comprehensive --duration 300

# Execute specific benchmark
npx gemiflow benchmark-run --suite throughput --iterations 10

# Compare with baseline
npx gemiflow benchmark-compare --current <results> --baseline <baseline>

# Quality assessment
npx gemiflow quality-assess --target swarm-performance --criteria throughput,latency

# Performance validation
npx gemiflow validate-performance --results <file> --criteria <file>
```

### Regression Detection Commands
```bash
# Detect performance regressions
npx gemiflow detect-regression --current <results> --historical <data>

# Set up automated regression monitoring
npx gemiflow regression-monitor --enable --sensitivity 0.95

# Analyze error patterns
npx gemiflow error-analysis --logs <log-files>
```
