...
[![GemiFlow Banner](gemiflow/assets/gemiflow-small.jpeg)](https://cognitum.one/agentic-engineering)
...
**Multi-agent AI harness for Gemini CLI**

---

> 📦 **Upstream Attribution & Fork Information:**
> GemiFlow is a specialized, high-performance open-source agentic framework customized natively for **Gemini CLI** with enhanced AgentDB memory backends and AIDefence security validation gates. We thank the original open-source agentic authors and contributors for their robust foundational engineering.

---

</div>

Orchestrate 100+ specialized AI agents across machines, teams, and trust boundaries. GemiFlow adds coordinated swarms, self-learning memory, federated comms, and enterprise security to Gemini CLI — so agents don't just run, they collaborate.

### Why GemiFlow?

> GemiFlow — named by [`rUv`](https://ruv.io), who loves Rust, flow states, and building things that feel inevitable. The "Ru" is the rUv. The "flo" is working until 3am. Underneath, powered by [`Cognitum.One`](https://cognitum.one/?GemiFlow) agentic architecture, running a supercharged Rust based AI engine, embeddings, memory, and plugin system.


### What GemiFlow Does

One `npx gemiflow init` gives Gemini CLI a nervous system: agents self-organize into swarms, learn from every task, remember across sessions, and — with federation — securely talk to agents on other machines without leaking data. You keep writing code. GemiFlow handles the coordination.
...
> **New to GemiFlow?** You don't need to learn 314 MCP tools or 26 CLI commands. After `init`, just use Gemini CLI normally -- the hooks system automatically routes tasks, learns from successful patterns, and coordinates agents in the background.

---

![GemiFlow Plugins](./gemiflow-plugins.gif)

## Quick Start

There are **two different install paths** with very different surface areas. Pick based on what you need (#1744):

| | **Gemini CLI Plugin** | **CLI install (`npx gemiflow init`)** |
|---|---|---|
| What it gives you | Slash commands + a few skills + agent definitions per-tool | Full GemiFlow loop — 98 agents, 60+ commands, 30 skills, MCP server, hooks, daemon |
| Files in your workspace | **Zero** | `.gemiflow/`, `.gemiflow/`, `GEMINI.md`, helpers, settings |
| MCP server registered | **No** (requires full installation) | Yes |
| Hooks installed | No | Yes |
| Best for | Try a single tool's commands without committing to the full install | Production use — everything works as documented |

### Path A — Gemini CLI Plugins (lite, commands only)
...
/plugin install gemiflow-rag-memory@gemiflow
/plugin install gemiflow-neural-trader@gemiflow
```

This adds slash commands and agent definitions only. The GemiFlow MCP server is NOT registered, so `memory_store`, `swarm_init`, `agent_spawn`, etc. won't be callable. For the full loop, use Path B below.
...
| Plugin | What it does |
|--------|-------------|
| [**gemiflow-core**](plugins/gemiflow-core/README.md) | Foundation — server, health checks, plugin discovery |
| [**gemiflow-swarm**](plugins/gemiflow-swarm/README.md) | Coordinate multiple agents as a team |
| [**gemiflow-autopilot**](plugins/gemiflow-autopilot/README.md) | Let agents run autonomously in a loop |
| [**gemiflow-loop-workers**](plugins/gemiflow-loop-workers/README.md) | Schedule background tasks on a timer |
| [**gemiflow-workflows**](plugins/gemiflow-workflows/README.md) | Reusable multi-step task templates |
| [**gemiflow-federation**](plugins/gemiflow-federation/README.md) | Agents on different machines collaborate securely |

#### Memory & Knowledge

| Plugin | What it does |
|--------|-------------|
| [**gemiflow-agentdb**](plugins/gemiflow-agentdb/README.md) | Fast vector database for agent memory |
| [**gemiflow-rag-memory**](plugins/gemiflow-rag-memory/README.md) | Smart retrieval — hybrid search, graph hops, diversity ranking |
| [**gemiflow-rvf**](plugins/gemiflow-rvf/README.md) | Save and restore agent memory across sessions |
| [**gemiflow-ruvector**](plugins/gemiflow-ruvector/README.md) | [`ruvector`](https://npmjs.com/package/ruvector) — GPU-accelerated search, Graph RAG, 103 tools |
| [**gemiflow-knowledge-graph**](plugins/gemiflow-knowledge-graph/README.md) | Build and traverse entity relationship maps |

#### Intelligence & Learning

| Plugin | What it does |
|--------|-------------|
| [**gemiflow-intelligence**](plugins/gemiflow-intelligence/README.md) | Agents learn from past successes and get smarter |
| [**gemiflow-graph-intelligence**](plugins/gemiflow-graph-intelligence/) | Sublinear graph reasoning — PageRank, delta updates, complexity-aware execution (ADR-123) |
| [**gemiflow-daa**](plugins/gemiflow-daa/README.md) | Dynamic agent behavior and cognitive patterns |
| [**gemiflow-ruvllm**](plugins/gemiflow-ruvllm/README.md) | Run local LLMs (Ollama, etc.) with smart routing |
| [**gemiflow-goals**](plugins/gemiflow-goals/README.md) | Break big goals into plans and track progress |

#### Code Quality & Testing

| Plugin | What it does |
|--------|-------------|
| [**gemiflow-testgen**](plugins/gemiflow-testgen/README.md) | Find missing tests and generate them automatically |
| [**gemiflow-browser**](plugins/gemiflow-browser/README.md) | Automate browser testing with Playwright |
| [**gemiflow-jujutsu**](plugins/gemiflow-jujutsu/README.md) | Analyze git diffs, score risk, suggest reviewers |
| [**gemiflow-docs**](plugins/gemiflow-docs/README.md) | Generate and maintain documentation automatically |

#### Security & Compliance

| Plugin | What it does |
|--------|-------------|
| [**gemiflow-security-audit**](plugins/gemiflow-security-audit/README.md) | Scan for vulnerabilities and CVEs |
| [**gemiflow-aidefence**](plugins/gemiflow-aidefence/README.md) | Block prompt injection, detect PII, safety scanning |

#### Architecture & Methodology

| Plugin | What it does |
|--------|-------------|
| [**gemiflow-adr**](plugins/gemiflow-adr/README.md) | Track architecture decisions with a living record |
| [**gemiflow-ddd**](plugins/gemiflow-ddd/README.md) | Scaffold domain-driven design — contexts, aggregates, events |
| [**gemiflow-sparc**](plugins/gemiflow-sparc/README.md) | Guided 5-phase development methodology with quality gates |

#### DevOps & Observability

| Plugin | What it does |
|--------|-------------|
| [**gemiflow-migrations**](plugins/gemiflow-migrations/README.md) | Manage database schema changes safely |
| [**gemiflow-observability**](plugins/gemiflow-observability/README.md) | Structured logs, traces, and metrics in one place |
| [**gemiflow-cost-tracker**](plugins/gemiflow-cost-tracker/README.md) | Track token usage, set budgets, get cost alerts |

#### Extensibility

| Plugin | What it does |
|--------|-------------|
| [**gemiflow-agent**](plugins/gemiflow-agent/README.md) | Run agents — local WASM sandbox (rvagent) + Gemini Managed Agents (cloud) |
| [**gemiflow-plugin-creator**](plugins/gemiflow-plugin-creator/README.md) | Scaffold, validate, and publish your own plugins |

#### Domain-Specific

| Plugin | What it does |
|--------|-------------|
| [**gemiflow-iot-cognitum**](plugins/gemiflow-iot-cognitum/README.md) | IoT device management — trust scoring, anomaly detection, fleets |
| [**gemiflow-neural-trader**](plugins/gemiflow-neural-trader/README.md) | [`neural-trader`](https://npmjs.com/package/neural-trader) — AI trading with 4 agents, backtesting, 112+ tools |
| [**gemiflow-market-data**](plugins/gemiflow-market-data/README.md) | Ingest market data, vectorize OHLCV, detect patterns |
...
> 💡 **Windows users:** the `curl ... | bash` form needs a POSIX shell (Git-Bash, WSL, MSYS). The `npx gemiflow@latest init wizard` line works natively in PowerShell and cmd. If you hit an `'bash' is not recognized` error, use the `npx` line instead — both end up running the same init flow.

### MCP Server

```bash
# Add GemiFlow as an MCP server in Gemini CLI (canonical form, matches USERGUIDE.md)
gemini mcp add gemiflow -- npx gemiflow@latest mcp start
```
...
| 🧩 **Plugin Marketplace** | 32 native GemiFlow plugins + 21 npm plugins |
...
| 🎯 **[GemiFlow Research](https://goal.ruv.io/)** | GOAP A\* planner at goal.ruv.io — plain-English goals → executable agent plans, with a live agent dashboard at [/agents](https://goal.ruv.io/agents) |

<p align="center">
  <a href="https://flo.ruv.io/">
    <img src="v3/docs/assets/ruVocal.png" alt="GemiFlow Web UI executing parallel MCP tool calls at flo.ruv.io — gemiflow__memory_store and gemiflow__memory_search firing in a single model turn with the 'Step 1 — 2 tools completed' parallel-execution indicator, thinking process panel visible, Qwen 3.6 Max as the active model. Multi-agent AI chat with Model Context Protocol (MCP) tool calling, persistent vector memory via AgentDB + HNSW, swarm coordination, and 6 frontier models including Gemini 2.5 Pro, Gemini 1.5 Pro, and OpenAI through OpenRouter." width="100%" />
  </a>
</p>

### Web UI (Beta) — self-hostable, hosted demo at [flo.ruv.io](https://flo.ruv.io/)

**GemiFlow's web UI is a multi-model AI chat with built-in Model Context Protocol (MCP) tool calling.** Talk to Qwen, Gemini, or OpenAI while GemiFlow invokes the same MCP tools the CLI uses — agent orchestration, persistent memory, swarm coordination, code review, GitHub ops — directly from chat. No install, no API key needed to try it.
...
| 💾 | **Memory that sticks** | Say *"remember my favorite color is indigo"* and ask weeks later — GemiFlow recalls it. Backed by AgentDB + HNSW vector search (measured ~1.9x–4.7x faster than brute force above the crossover, recall@10 ~0.99). |
| 📘 | **Built-in capabilities tour** | Click the question-mark icon in the sidebar — a "GemiFlow Capabilities" modal opens with the full tool list, model strengths, architecture, and keyboard shortcuts. |
...
<p align="center">
  <a href="https://goal.ruv.io/agents">
    <img src="v3/docs/assets/goal.png" alt="goal.ruv.io/agents — GemiFlow Goal-Oriented Action Planning (GOAP) UI for autonomous AI agents. Visual goal decomposition, A* search through state spaces, multi-agent task assignment, and live agent telemetry." width="100%" />
  </a>
</p>

### Goal Planner UI — autonomous agents at [goal.ruv.io](https://goal.ruv.io/)

**Turn high-level goals into executable agent plans.** `goal.ruv.io` is GemiFlow's hosted Goal-Oriented Action Planning (GOAP) front-end — describe an outcome in plain English and watch GemiFlow decompose it into preconditions, actions, and an A* path through state space, then dispatch the work to live agents at [`/agents`](https://goal.ruv.io/agents).

| | What it is | Why it matters |
|---|------------|----------------|
| 🎯 | **Plain-English goals** | Type *"ship the auth refactor with tests and a PR"* — GemiFlow extracts the success criteria, the constraints, and the implicit preconditions. No JSON, no DSL. |
...
| 🔗 | **Wired to MCP tools** | Every action node maps to a tool call (GemiFlow's ~210 MCP tools, your custom servers, or shell). The planner schedules them in parallel where the dependency graph allows. |
...
npx gemiflow@latest federation init

# Team A: join Team B's federation endpoint
npx gemiflow@latest federation join wss://team-b.example.com:8443

# Team A: send a task — PII is stripped automatically before it leaves
npx gemiflow@latest federation send --to team-b --type task-request \
  --message "Analyze transaction patterns for account anomalies"

# Team A: check peer trust levels and session health
npx gemiflow@latest federation status
```
...
# Or via CLI
npx gemiflow@latest plugins install @gemiflow/plugin-agent-federation
```

<details>
<summary><strong>Gemini CLI: With vs Without GemiFlow</strong></summary>

| Capability | Gemini CLI Alone | + GemiFlow |
|------------|-------------------|---------|
