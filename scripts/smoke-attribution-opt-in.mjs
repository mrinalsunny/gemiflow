...
const SCAN_TARGETS = [
  collectMarkdown(join(ROOT, '.gemiflow/agents/github'), false),
  collectMarkdown(join(ROOT, '.gemiflow/skills'), true).filter(f => f.includes('/github-')),
  collectMarkdown(join(ROOT, 'v3/@gemiflow/cli/.gemiflow/commands/github'), false),
];
