 ...
 *  4. gemiflow-plugin-creator SKILL.md mentions graph_adapter stub
 *
...
async function testPluginJsonStub() {
  console.log('\nTEST 2: gemiflow-plugin-creator SKILL.md mentions graph_adapter stub');
  try {
    const skillPath = path.join(projectRoot, 'plugins/gemiflow-plugin-creator/skills/create-plugin/SKILL.md');
...
async function testAdapterExports() {
  ...
  try {
    const adapterPath = path.join(projectRoot, 'plugins/gemiflow-graph-intelligence/src/adapters/knowledge-graph-adapter.ts');
...
async function testAdapterBackwardCompat() {
  ...
  try {
    const adaptersDir = path.join(projectRoot, 'plugins/gemiflow-graph-intelligence/src/adapters');
