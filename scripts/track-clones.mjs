#!/usr/bin/env node
/**
 * Clone tracker — fetches 14-day GitHub clone numbers for the gemiflow
 ...
 *   [gemiflow_clones,      gemiflow_uniques,
...
function readLedger() {
  if (!existsSync(LEDGER_PATH)) {
    return {
      schema: 'gemiflow-clone-tracker-ledger/v1',
...
async function main() {
  ...
  const proof = {
    schema: 'gemiflow-ecosystem-proof/v2',
    generated_at: now,
    sources: {
