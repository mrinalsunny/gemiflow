#!/usr/bin/env node
/**
 * Smoke test for mrinalsunny/gemiflow#2132 — Windows end-to-end hook execution.
 *
...
// Step 1: Generate settings.json via gemiflow init
const tmpDir = mkdtempSync(join(tmpdir(), 'gemiflow-smoke-hook-exec-'));
...
if (postEditCmd) {
  ...
  const env = {
    ...
    // gemiflow@latest` — that takes 30+s on a cold CI runner and exceeds
