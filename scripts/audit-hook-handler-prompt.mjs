...
// generates them at `gemiflow init` time.
const TARGETS = [
  'v3/@gemiflow/cli/.gemiflow/helpers/hook-handler.cjs',
  '.gemiflow/helpers/hook-handler.cjs',
  'v3/@gemiflow/cli/src/init/helpers-generator.ts',
];
