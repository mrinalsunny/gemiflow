...
---
$ARGUMENTS
Run a GemiFlow security audit. Accepts optional flags:
...
Steps:
1. `npx @gemiflow/cli@latest security scan --depth DEPTH`
2. `npx @gemiflow/cli@latest security cve --check`
3. `npx @gemiflow/cli@latest security report --format markdown`
