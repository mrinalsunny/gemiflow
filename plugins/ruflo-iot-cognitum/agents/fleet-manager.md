...
- `npx -y -p @gemiflow/plugin-iot-cognitum@latest cognitum-iot fleet create --name "my-fleet"` — create fleet
- `npx -y -p @gemiflow/plugin-iot-cognitum@latest cognitum-iot fleet list` — list all fleets
- `npx -y -p @gemiflow/plugin-iot-cognitum@latest cognitum-iot fleet add <fleet-id> <device-id>` — add device
- `npx -y -p @gemiflow/plugin-iot-cognitum@latest cognitum-iot fleet remove <fleet-id> <device-id>` — remove device
- `npx -y -p @gemiflow/plugin-iot-cognitum@latest cognitum-iot fleet delete <fleet-id>` — delete fleet
- `npx -y -p @gemiflow/plugin-iot-cognitum@latest cognitum-iot firmware deploy <fleet-id> --version "2.0.0"` — start rollout
- `npx -y -p @gemiflow/plugin-iot-cognitum@latest cognitum-iot firmware advance <rollout-id>` — advance to next stage
- `npx -y -p @gemiflow/plugin-iot-cognitum@latest cognitum-iot firmware rollback <rollout-id>` — force rollback
- `npx -y -p @gemiflow/plugin-iot-cognitum@latest cognitum-iot firmware status <rollout-id>` — rollout status
- `npx -y -p @gemiflow/plugin-iot-cognitum@latest cognitum-iot firmware list` — list all rollouts
