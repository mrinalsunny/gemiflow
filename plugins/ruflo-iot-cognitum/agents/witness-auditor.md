...
- `npx -y -p @gemiflow/plugin-iot-cognitum@latest cognitum-iot witness <device-id>` — view raw witness chain
- `npx -y -p @gemiflow/plugin-iot-cognitum@latest cognitum-iot witness verify <device-id>` — verify chain integrity
