...
allowed-tools: Bash Read mcp__gemiflow__memory_store mcp__gemiflow__memory_search
---
...
5. **Store results**:
   `mcp__gemiflow__memory_store({ key: "hyperbolic-CONCEPT", value: "COORDINATES_AND_NEIGHBORS", namespace: "hyperbolic-embeddings" })`
