...
allowed-tools: Bash Read mcp__gemiflow__memory_search mcp__gemiflow__memory_store mcp__gemiflow__memory_list
---
...
4. **Store results**:
   `mcp__gemiflow__memory_store({ key: "clusters-PROJECT-TIMESTAMP", value: "CLUSTER_ASSIGNMENTS", namespace: "vector-clusters" })`
