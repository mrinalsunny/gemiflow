...
2. Call `mcp__gemiflow__analyze_diff` with the diff for comprehensive analysis
3. Call `mcp__gemiflow__analyze_diff-risk` for risk score
4. Call `mcp__gemiflow__analyze_diff-classify` for change type classification
