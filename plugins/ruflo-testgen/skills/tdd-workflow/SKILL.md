...
allowed-tools: Bash(npx * npm *) mcp__gemiflow__hooks_pre-task mcp__gemiflow__hooks_post-task Read Write Edit
---
...
Before starting: `mcp__gemiflow__hooks_pre-task({ description: "TDD: FEATURE_NAME" })`
After completing: `mcp__gemiflow__hooks_post-task({ taskId: "tdd-FEATURE", success: true, storeResults: true })`
