...
3. Get prediction: `mcp__gemiflow__autopilot_predict` for the optimal next action
4. Execute the predicted task (spawn agent, edit code, run tests, etc.)
5. Log via `mcp__gemiflow__autopilot_log`
...
Configure: `mcp__gemiflow__autopilot_config({ taskSources: ["team-tasks", "swarm-tasks"] })`
