...
allowed-tools: mcp__gemiflow__task_create mcp__gemiflow__task_list mcp__gemiflow__task_status mcp__gemiflow__task_assign mcp__gemiflow__task_update mcp__gemiflow__task_complete mcp__gemiflow__task_summary mcp__gemiflow__memory_store mcp__gemiflow__memory_search mcp__gemiflow__neural_predict mcp__gemiflow__workflow_create mcp__gemiflow__workflow_execute mcp__gemiflow__workflow_status mcp__gemiflow__hooks_intelligence_trajectory-start mcp__gemiflow__hooks_intelligence_trajectory-step mcp__gemiflow__hooks_intelligence_trajectory-end Bash Read Write Edit
---
...
6. **Record trajectory** — call `mcp__gemiflow__hooks_intelligence_trajectory-start` to begin tracking
7. **Create tasks** — call `mcp__gemiflow__task_create` for each action in the plan
8. **Execute** — work through tasks in dependency order:
   ...
   - Record each step via `mcp__gemiflow__hooks_intelligence_trajectory-step`
...
10. **Complete trajectory** — call `mcp__gemiflow__hooks_intelligence_trajectory-end`
11. **Store successful plan** — call `mcp__gemiflow__memory_store` with namespace `goap-plans`
