...
[[ -f "$ROOT/commands/gemiflow-sparc.md" ]] || miss="$miss missing-command"
[[ -z "$miss" ]] && ok || bad "$miss"
...
F="$ROOT/commands/gemiflow-sparc.md"
...
F="$ROOT/README.md"
miss=""
for plugin in gemiflow-adr gemiflow-ddd gemiflow-jujutsu gemiflow-docs gemiflow-goals; do
