...
Display the current HAL GAIA leaderboard and compare with stored gemiflow runs.
...
...
 --   gemiflow (this session)    20.8    --     --     20.8*
```
...
| gemiflow iter 23 | 20.8% | 53 Q, post-SOTA web_search |
...
3. Load local runs: `npx @gemiflow/cli@latest memory list --namespace gaia-runs`
