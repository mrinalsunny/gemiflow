...
5. Dispatch doc worker for large-scale generation: `npx @gemiflow/cli@latest hooks worker dispatch --trigger document`
...
- `npx @gemiflow/cli@latest hooks worker dispatch --trigger document` — bulk generation
