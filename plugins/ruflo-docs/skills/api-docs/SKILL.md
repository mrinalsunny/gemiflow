...
allowed-tools: Bash(npx *) mcp__gemiflow__hooks_worker-dispatch Read Write Grep
---
...
Dispatch via MCP: `mcp__gemiflow__hooks_worker-dispatch({ trigger: "document", scope: "api" })`
