...
allowed-tools: Bash(npx *) mcp__gemiflow__memory_search Read Grep
...
2. `npx -y -p @gemiflow/plugin-agent-federation@latest gemiflow-federation audit --compliance MODE --since DATE --severity LEVEL`
