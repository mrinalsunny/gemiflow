...
[![npm version](https://img.shields.io/npm/v/@gemiflow/embeddings.svg)](https://www.npmjs.com/package/@gemiflow/embeddings)
[![npm downloads](https://img.shields.io/npm/dm/@gemiflow/embeddings.svg)](https://www.npmjs.com/package/@gemiflow/embeddings)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![Performance](https://img.shields.io/badge/Performance-<5ms-brightgreen.svg)](https://github.com/mrinalsunny/gemiflow)

> High-performance embedding generation module for GemiFlow V3 - multi-provider support with persistent caching, document chunking, normalization, hyperbolic embeddings, and neural substrate integration.
...
```bash
npm install @gemiflow/embeddings
```

## Standalone use (without the GemiFlow CLI)

This package runs on its own — no `@gemiflow/cli`, no MCP server,
...
gemiflow embeddings init --provider agentic-flow
```
...
```typescript
import { OpenAIEmbeddingService } from '@gemiflow/embeddings';
...
```typescript
import { AgenticFlowEmbeddingService } from '@gemiflow/embeddings';
...
```typescript
import { TransformersEmbeddingService } from '@gemiflow/embeddings';
...
```typescript
import { MockEmbeddingService } from '@gemiflow/embeddings';
...
```typescript
import { createEmbeddingService } from '@gemiflow/embeddings';
...
```typescript
import { chunkText, estimateTokens, reconstructFromChunks } from '@gemiflow/embeddings';
...
```typescript
import { PersistentEmbeddingCache, isPersistentCacheAvailable } from '@gemiflow/embeddings';
...
# Neural operations
gemiflow embeddings neural drift --baseline "context" --input "check this"
...
- [@gemiflow/memory](../memory) - HNSW indexing and vector storage
- [@gemiflow/providers](../providers) - Multi-LLM provider system
- [@gemiflow/neural](../neural) - SONA learning integration
