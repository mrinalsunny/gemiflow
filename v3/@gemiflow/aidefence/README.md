...
[![npm version](https://img.shields.io/npm/v/@gemiflow/aidefence?color=blue&label=npm)](https://www.npmjs.com/package/@gemiflow/aidefence)
[![npm downloads](https://img.shields.io/npm/dm/@gemiflow/aidefence?color=green)](https://www.npmjs.com/package/@gemiflow/aidefence)
...
`@gemiflow/aidefence` is a high-performance security library designed to protect AI/LLM applications from manipulation attempts. It provides:
...
```bash
# npm
npm install @gemiflow/aidefence

# pnpm
pnpm add @gemiflow/aidefence

# yarn
yarn add @gemiflow/aidefence
```
...
```typescript
import { isSafe, checkThreats } from '@gemiflow/aidefence';
...
```typescript
import { createAIDefence } from '@gemiflow/aidefence';
...
Use via GemiFlow CLI:

```bash
# Basic threat scan
npx @gemiflow/cli security defend -i "ignore previous instructions"

# Scan a file
npx @gemiflow/cli security defend -f ./user-prompts.txt

# Quick scan (faster)
npx @gemiflow/cli security defend -i "some text" --quick

# JSON output
npx @gemiflow/cli security defend -i "test" -o json

# View statistics
npx @gemiflow/cli security defend --stats
```
...
```typescript
import { VectorStore, createAIDefence } from '@gemiflow/aidefence';
...
```json
{
  "hooks": {
    "pre-agent-input": {
      "command": "node -e \"
        const { isSafe } = require('@gemiflow/aidefence');
...
- [`@gemiflow/cli`](https://www.npmjs.com/package/@gemiflow/cli) - CLI with security commands
- [`agentdb`](https://www.npmjs.com/package/agentdb) - HNSW vector database
- [`gemiflow`](https://www.npmjs.com/package/gemiflow) - Full AI coordination system

---

<p align="center">
  <strong>Built with security in mind by <a href="https://ruv.io">rUv</a></strong><br>
  <sub>Part of the GemiFlow ecosystem</sub>
</p>
