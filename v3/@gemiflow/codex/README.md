...
Both platforms share the same `.gemiflow/` runtime:
...
npx gemiflow memory list

# Manually add a test pattern
npx gemiflow memory store --key "test" --value "test pattern" --namespace patterns
```
...
# Rebuild index
npx gemiflow memory optimize --rebuild-index
```
...
| Package | Description |
|---------|-------------|
| [@gemiflow/cli](https://www.npmjs.com/package/@gemiflow/cli) | Main CLI (26 commands, 140+ subcommands) |
| [gemiflow](https://www.npmjs.com/package/gemiflow) | Umbrella package |
| [@gemiflow/memory](https://www.npmjs.com/package/@gemiflow/memory) | AgentDB with HNSW vector search |
| [@gemiflow/security](https://www.npmjs.com/package/@gemiflow/security) | Security module |
