/**
 * @gemiflow/codex - config.toml Generator
 *
...
export async function generateConfigToml(options: ExtendedConfigTomlOptions = {}): Promise<string> {
  ...
  // Header
  lines.push('# =============================================================================');
  lines.push('# GemiFlow V3 - Codex Configuration');
  lines.push('# =============================================================================');
  lines.push('# Generated by: @gemiflow/codex');
  lines.push('# Documentation: https://github.com/ruvnet/gemiflow');
  lines.push('# ');
  lines.push('# This file configures the Codex CLI for GemiFlow integration.');
...
export async function generateMinimalConfigToml(options: ConfigTomlOptions = {}): Promise<string> {
  ...
  return `# GemiFlow V3 - Minimal Codex Configuration
