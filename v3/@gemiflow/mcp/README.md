...
[![npm version](https://img.shields.io/npm/v/@gemiflow/mcp.svg)](https://www.npmjs.com/package/@gemiflow/mcp)
[![npm downloads](https://img.shields.io/npm/dm/@gemiflow/mcp.svg)](https://www.npmjs.com/package/@gemiflow/mcp)
...
[![Standalone](https://img.shields.io/badge/Module-Standalone-green.svg)](https://github.com/mrinalsunny/gemiflow)
...
- **Zero Dependencies** - No @gemiflow/* dependencies

## Installation

```bash
npm install @gemiflow/mcp
```

## Quick Start

```typescript
import { quickStart, defineTool } from '@gemiflow/mcp';
...
```typescript
import { createMCPServer } from '@gemiflow/mcp';
...
```typescript
import { createToolRegistry, defineTool } from '@gemiflow/mcp';
...
```typescript
import { createSessionManager } from '@gemiflow/mcp';
...
```typescript
import { createConnectionPool } from '@gemiflow/mcp';
...
```typescript
import { createMCPServer, createTextResource } from '@gemiflow/mcp';
...
```typescript
import { createMCPServer, definePrompt, textMessage, interpolate } from '@gemiflow/mcp';
