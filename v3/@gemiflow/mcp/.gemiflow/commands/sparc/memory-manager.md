...
npx gemiflow sparc run memory-manager "organize project knowledge"

# For alpha features
npx gemiflow@alpha sparc run memory-manager "organize project knowledge"
```

### Option 3: Local Installation
```bash
# If gemiflow is installed locally
./gemiflow sparc run memory-manager "organize project knowledge"
```
