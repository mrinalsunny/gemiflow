...
npx gemiflow sparc run refinement-optimization-mode "optimize database queries"

# For alpha features
npx gemiflow@alpha sparc run refinement-optimization-mode "optimize database queries"

# With namespace
npx gemiflow sparc run refinement-optimization-mode "your task" --namespace refinement-optimization-mode

# Non-interactive mode
npx gemiflow sparc run refinement-optimization-mode "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If gemiflow is installed locally
./gemiflow sparc run refinement-optimization-mode "optimize database queries"
```
...
```bash
# Store mode-specific context
npx gemiflow memory store "refinement-optimization-mode_context" "important decisions" --namespace refinement-optimization-mode

# Query previous work
npx gemiflow memory query "refinement-optimization-mode" --limit 5
```
