 ...
 *
 * @module @gemiflow/plugins/integrations/ruvector
 * @version 1.0.0
 */
...
class ConnectionManager extends EventEmitter {
  ...
  private buildPoolConfig(): PgPoolConfig {
    ...
    return {
      ...
      application_name: this.config.applicationName ?? 'gemiflow-ruvector',
    };
  }
...
/**
 * RuVector PostgreSQL Bridge Plugin for GemiFlow v3.
 *
...
export class RuVectorBridge extends BasePlugin {
  ...
  constructor(config: RuVectorConfig) {
    super({
      ...
      description: 'RuVector PostgreSQL Bridge for GemiFlow v3 - Advanced vector database integration',
