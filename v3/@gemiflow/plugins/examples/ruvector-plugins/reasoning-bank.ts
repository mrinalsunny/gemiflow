 ...
 * @example
 * ```typescript
 * import { reasoningBankPlugin } from '@gemiflow/plugins/examples/ruvector-plugins';
...
export class ReasoningBank {
   ...
   * When set, uses @gemiflow/embeddings for high-quality embeddings
   */
  private embeddingProvider: ((text: string) => Promise<Float32Array>) | null = null;

  /**
   * Set external embedding provider from @gemiflow/embeddings
   *
   * @example
   * ```typescript
   ...
   * Used when @gemiflow/embeddings is not configured
   */
