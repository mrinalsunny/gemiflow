...
[![npm version](https://img.shields.io/npm/v/@gemiflow/plugins.svg)](https://www.npmjs.com/package/@gemiflow/plugins)
[![npm downloads](https://img.shields.io/npm/dm/@gemiflow/plugins.svg)](https://www.npmjs.com/package/@gemiflow/plugins)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

**Unified Plugin SDK for GemiFlow V3**

A comprehensive plugin development framework providing workers, hooks, providers, and security utilities for building GemiFlow extensions.

## Installation

```bash
npm install @gemiflow/plugins
```
...
const myPlugin = new PluginBuilder('my-awesome-plugin', '1.0.0')
  .withDescription('My awesome plugin for GemiFlow')
...
import { getDefaultRegistry } from '@gemiflow/plugins';
...
```typescript
import { createToolPlugin, createHooksPlugin, createWorkerPlugin } from '@gemiflow/plugins';
...
```typescript
import { MCPToolBuilder } from '@gemiflow/plugins';
...
```typescript
import { HookBuilder, HookFactory, HookRegistry, HookEvent, HookPriority } from '@gemiflow/plugins';
...
```typescript
import { WorkerPool, WorkerFactory } from '@gemiflow/plugins';
...
```typescript
import { AgenticFlowBridge, AgentDBBridge } from '@gemiflow/plugins';
...
```typescript
import { Security, createRateLimiter, createResourceLimiter } from '@gemiflow/plugins';
