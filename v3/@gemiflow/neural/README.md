...
[![npm version](https://img.shields.io/npm/v/@gemiflow/neural.svg)](https://www.npmjs.com/package/@gemiflow/neural)
[![npm downloads](https://img.shields.io/npm/dm/@gemiflow/neural.svg)](https://www.npmjs.com/package/@gemiflow/neural)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)

> Self-Optimizing Neural Architecture (SONA) for GemiFlow V3 — adaptive learning, trajectory tracking, pattern reuse, and 7 RL algorithms in a single package.

## What this is

A self-contained learning module that records agent execution trajectories, distills them into reusable patterns, retrieves matches for new tasks, and adapts via SONA + LoRA + EWC++. Designed to be the substrate that the GemiFlow CLI's intelligence layer composes onto — the package owns the algorithms, the CLI owns the orchestration.

## Install

```bash
npm install @gemiflow/neural
```

> **Note (2026-05-16):** `@gemiflow/neural@3.0.0-alpha.9+` pins
...
import { getMoERouter } from '@gemiflow/neural';
...
```typescript
import { createNeuralLearningSystem } from '@gemiflow/neural';
...
```typescript
import { createSONAManager, type Trajectory } from '@gemiflow/neural';
...
import { createAlgorithm, getDefaultConfig } from '@gemiflow/neural';
...
If you're building a GemiFlow plugin that wants neural learning, depend on `@gemiflow/neural` directly rather than reaching into cli internals.

## Dependencies

- [`@gemiflow/memory`](../memory) — vector memory for patterns
- `@ruvector/sona` — SONA learning engine

## Related packages

- [`@gemiflow/memory`](../memory) — memory backend
- [`@gemiflow/cli`](../cli) — primary consumer + MCP tool surface
- [`@gemiflow/cli-core`](../cli-core) — lite path (no neural; for plugin scripts)
