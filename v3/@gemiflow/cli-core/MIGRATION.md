...
3. **If yes**, fall back to `cli@latest` for the affected call sites and document the gap; ping us on issue [#1760](https://github.com/ruvnet/gemiflow/issues/1760) so we can prioritize.
...
cli-core is alpha — please file feedback at https://github.com/ruvnet/gemiflow/issues with the label `cli-core-alpha`. Specifically helpful:
...
- [Issue #1748 #3](https://github.com/ruvnet/gemiflow/issues/1748) — the cold-cache problem this addresses
- [Issue #1760](https://github.com/ruvnet/gemiflow/issues/1760) — alpha tracking
- Branch [`feat/cli-core-split`](https://github.com/ruvnet/gemiflow/tree/feat/cli-core-split) — work in progress
