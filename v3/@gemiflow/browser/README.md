...
[![npm version](https://img.shields.io/npm/v/@gemiflow/browser?style=for-the-badge&logo=npm&color=blue)](https://www.npmjs.com/package/@gemiflow/browser)
[![npm downloads](https://img.shields.io/npm/dm/@gemiflow/browser?style=for-the-badge&logo=npm&color=cb3837)](https://www.npmjs.com/package/@gemiflow/browser)
...
**AI-Optimized Browser Automation for GemiFlow Swarms**

*Integrate [agent-browser](https://github.com/AugmentCode/agent-browser) with gemiflow for intelligent web automation, trajectory learning, security scanning, and multi-agent browser coordination.*
...
`@gemiflow/browser` provides a comprehensive browser automation layer for AI agents, combining Vercel Labs' `agent-browser` CLI with gemiflow's learning, memory, and security capabilities. It enables agents to navigate websites, fill forms, extract data, and learn from successful interaction patterns.
...
npm install @gemiflow/cli@^3.0.0-alpha
...
```typescript
import { createBrowserService, browserTools } from '@gemiflow/browser';
...
Register browser tools with gemiflow's MCP server:

```typescript
import { browserTools } from '@gemiflow/browser';
...
```typescript
import { createMemoryManager } from '@gemiflow/browser';
...
```typescript
import { listWorkflows, getWorkflow, getWorkflowManager } from '@gemiflow/browser';
...
```typescript
import { preBrowseHook, postBrowseHook, browserHooks } from '@gemiflow/browser';
...
```typescript
import { createBrowserSwarm } from '@gemiflow/browser';
...
```typescript
import { createBrowserService, getSecurityScanner } from '@gemiflow/browser';
