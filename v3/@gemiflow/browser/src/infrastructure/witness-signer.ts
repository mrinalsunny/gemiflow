/**
 * @gemiflow/browser - Witness Signer (ADR-122 Phase 1)
 *
 ...
 * project-keyed witness via the `GEMIFLOW_BROWSER_WITNESS_KEY` env var.
 */
...
export function resolveWitnessKey(): WitnessKey {
  const envKey = process.env.GEMIFLOW_BROWSER_WITNESS_KEY;
