/**
 * @gemiflow/browser - MCP Tools
 * 50+ browser automation tools for gemiflow MCP server
 */
...
const MAX_EVAL_SCRIPT_LENGTH = parseInt(process.env.GEMIFLOW_MAX_EVAL_SCRIPT_LENGTH || '', 10) || DEFAULT_MAX_EVAL_SCRIPT_LENGTH;
