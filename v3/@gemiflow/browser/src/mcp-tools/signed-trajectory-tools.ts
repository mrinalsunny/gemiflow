/**
 * @gemiflow/browser - Signed Trajectory MCP Tools (ADR-122 Phase 1)
 *
...
export const signedTrajectoryTools: MCPTool[] = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        privateKeyPem: { type: 'string', description: 'Optional Ed25519 PEM private key (else env GEMIFLOW_BROWSER_WITNESS_KEY or ephemeral)' },
  ...
  },
  {
    ...
    description:
      'Generate a fresh Ed25519 witness keypair for signing trajectories. Returns publicKeyHex + PEM-encoded private key. Store the private key securely (e.g. GEMIFLOW_BROWSER_WITNESS_KEY env var).',
    category: 'browser-trajectory',
    inputSchema: {
      type: 'object',
      properties: {},
    ...
    handler: async () => {
      ...
      return {
        ...
        privateKeyPem,
        publicKeyPem,
        envVarHint: 'set GEMIFLOW_BROWSER_WITNESS_KEY to the privateKeyPem value',
      };
    },
  },
];
