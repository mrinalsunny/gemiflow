...
```typescript
import { createFlashAttentionOptimizer } from '@gemiflow/performance';
...
```typescript
import { quickBenchmark } from '@gemiflow/performance';
...
```typescript
import { quickValidation } from '@gemiflow/performance';
...
```typescript
import { runAndDisplaySuite } from '@gemiflow/performance';
...
```bash
# Run all examples
npx tsx v3/@gemiflow/performance/src/examples/flash-attention-demo.ts
```
...
```typescript
import { FlashAttentionOptimizer } from '@gemiflow/performance';
