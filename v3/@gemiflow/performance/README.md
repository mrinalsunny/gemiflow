...
[![npm version](https://img.shields.io/npm/v/@gemiflow/performance.svg)](https://www.npmjs.com/package/@gemiflow/performance)
[![npm downloads](https://img.shields.io/npm/dm/@gemiflow/performance.svg)](https://www.npmjs.com/package/@gemiflow/performance)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![Benchmarks](https://img.shields.io/badge/Benchmarks-Vitest-green.svg)](https://vitest.dev/)

> Comprehensive performance benchmarking module for GemiFlow V3 - statistical analysis, memory tracking, regression detection, and Flash Attention validation.
...
```bash
npm install @gemiflow/performance
```
...
```typescript
import { benchmark } from '@gemiflow/performance';
...
- [@gemiflow/memory](../memory) - Memory operations to benchmark
- [@gemiflow/swarm](../swarm) - Swarm coordination to benchmark
- [@gemiflow/neural](../neural) - Neural operations to benchmark
