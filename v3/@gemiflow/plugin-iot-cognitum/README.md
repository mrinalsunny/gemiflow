...
[![npm version](https://img.shields.io/npm/v/@gemiflow/plugin-iot-cognitum.svg)](https://www.npmjs.com/package/@gemiflow/plugin-iot-cognitum)
[![npm downloads](https://img.shields.io/npm/dm/@gemiflow/plugin-iot-cognitum.svg)](https://www.npmjs.com/package/@gemiflow/plugin-iot-cognitum)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

IoT Cognitum Seed device-agent bridge — treat every Seed as a GemiFlow agent with hardware capabilities.
...
```bash
npx -y -p @gemiflow/plugin-iot-cognitum@latest cognitum-iot --help
```
...
```typescript
import { IoTCognitumPlugin } from '@gemiflow/plugin-iot-cognitum';
