...
export class IoTCognitumPlugin implements ClaudeFlowPlugin {
  ...
  readonly dependencies = ['@gemiflow/shared'];
    ...
    return [
      {
        ...
        description: 'Manages Cognitum Seed device fleet as GemiFlow agent swarm members',
        defaultConfig: {
          id: '',
          name: 'device-coordinator',
          type: 'coordinator',
          ...
          priority: 85,
          timeout: 300_000,
          metadata: { pluginSource: '@gemiflow/plugin-iot-cognitum' },
        },
