#!/usr/bin/env node
/**
 * Phase 1 micro-benchmarks for the @gemiflow/guidance optimization
 ...
 *
 * Usage:
 *   node v3/@gemiflow/cli ... build first
 *   node v3/@gemiflow/guidance/scripts/bench-phase-1.mjs --tag=baseline
 *   node v3/@gemiflow/guidance/scripts/bench-phase-1.mjs --tag=phase-1
 *
...
if (typeof CompilerCls === 'function') {
  ...
  // The compiler's hot path is `compile(geminiMdContent)` which does the full
