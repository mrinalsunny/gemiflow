...
Phase 1 benchmarks for the `@gemiflow/guidance` SOTA optimization
...
```bash
cd v3/@gemiflow/guidance && npm run build
node v3/@gemiflow/guidance/scripts/bench-phase-1.mjs --tag=baseline
node v3/@gemiflow/guidance/scripts/bench-retriever-scale.mjs --tag=baseline
```
