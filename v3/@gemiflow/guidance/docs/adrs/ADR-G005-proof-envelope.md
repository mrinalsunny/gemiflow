...
- `v3/@gemiflow/guidance/src/types.ts` -- `RunEvent`, `Violation`, `EvaluatorResult`, `ViolationRanking`, `OptimizationMetrics`
- `v3/@gemiflow/guidance/src/ledger.ts` -- `RunLedger`, all evaluator classes
- `v3/@gemiflow/guidance/src/compiler.ts` -- `hashContent()` for guidance hash generation
- `v3/@gemiflow/guidance/src/index.ts` -- `GuidanceControlPlane.startRun()`, `finalizeRun()`
