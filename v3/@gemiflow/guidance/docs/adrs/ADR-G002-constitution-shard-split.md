...
- `v3/@gemiflow/guidance/src/types.ts` -- `Constitution`, `RuleShard`, `PolicyBundle` type definitions
- `v3/@gemiflow/guidance/src/compiler.ts` -- `buildConstitution()`, `buildShards()`, `CONSTITUTION_MARKERS`
- `v3/@gemiflow/guidance/src/retriever.ts` -- `ShardRetriever.retrieve()`, `selectWithContradictionCheck()`
