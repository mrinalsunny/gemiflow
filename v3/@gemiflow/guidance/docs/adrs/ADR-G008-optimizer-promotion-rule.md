...
- `v3/@gemiflow/guidance/src/optimizer.ts` -- `OptimizerLoop.runCycle()`, `proposeChanges()`, `evaluateChange()`, `applyPromotions()`, `promotionTracker`
- `v3/@gemiflow/guidance/src/types.ts` -- `RuleChange`, `ABTestResult`, `OptimizationMetrics`, `ViolationRanking`, `RuleADR`
- `v3/@gemiflow/guidance/src/ledger.ts` -- `RunLedger.rankViolations()`, `computeMetrics()`
- `v3/@gemiflow/guidance/src/index.ts` -- `GuidanceControlPlane.optimize()`
