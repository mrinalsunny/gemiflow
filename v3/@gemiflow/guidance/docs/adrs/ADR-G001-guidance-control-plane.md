...
- `v3/@gemiflow/guidance/src/index.ts` -- `GuidanceControlPlane` orchestrator class
- `v3/@gemiflow/guidance/src/compiler.ts` -- `GuidanceCompiler`
- `v3/@gemiflow/guidance/src/retriever.ts` -- `ShardRetriever`
- `v3/@gemiflow/guidance/src/gates.ts` -- `EnforcementGates`
- `v3/@gemiflow/guidance/src/ledger.ts` -- `RunLedger`
- `v3/@gemiflow/guidance/src/optimizer.ts` -- `OptimizerLoop`
- `v3/@gemiflow/guidance/src/headless.ts` -- `HeadlessRunner`
- `v3/@gemiflow/guidance/src/types.ts` -- All type definitions
