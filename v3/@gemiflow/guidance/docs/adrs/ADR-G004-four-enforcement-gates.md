...
- `v3/@gemiflow/guidance/src/gates.ts` -- `EnforcementGates` class, `GateConfig`, default patterns
- `v3/@gemiflow/guidance/src/types.ts` -- `GateDecision`, `GateResult`, `GateConfig`
