...
```ts
import type { RunEvent } from '@gemiflow/guidance';
...
// Later, restore it
import { ProofChain } from '@gemiflow/guidance/proof';
...
```ts
import { createTruthAnchorStore } from '@gemiflow/guidance/truth-anchors';
