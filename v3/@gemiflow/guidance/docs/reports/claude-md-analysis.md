...
Generated: 2026-02-01 by `@gemiflow/guidance/analyzer`
...
cd v3/@gemiflow/guidance

# Run the analysis script
npx tsx scripts/analyze-claude-md.ts

# Or use the API programmatically
import { analyze, autoOptimize, formatReport } from '@gemiflow/guidance/analyzer';

const result = analyze(geminiMdContent);
console.log(formatReport(result));

const optimized = autoOptimize(geminiMdContent);
