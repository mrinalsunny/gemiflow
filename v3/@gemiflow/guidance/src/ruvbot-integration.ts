 ...
 *
 * Bridges ruvbot (npm: ruvbot@0.1.8) with the @gemiflow/guidance control
 ...
 *
 * @module @gemiflow/guidance/ruvbot-integration
 */
...
async function requireRuvBot(): Promise<Record<string, unknown>> {
  ...
  try {
    ...
    throw new Error(
      ...
      'ruvbot is an optional peer dependency of @gemiflow/guidance.',
    );
  }
}
...
/**
 * Bridges a ruvbot instance with the @gemiflow/guidance control plane.
 *
