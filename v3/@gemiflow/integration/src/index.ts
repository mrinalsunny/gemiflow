/**
 * @gemiflow/integration - V3 Integration Module
 *
 ...
 * Usage:
 * ```typescript
 * import { createAgenticFlowBridge } from '@gemiflow/integration';
 *
...
export const METADATA = {
  name: '@gemiflow/integration',
  version: VERSION,
  description: 'Deep agentic-flow@alpha integration for gemiflow v3',
  implements: ['ADR-001'],
  features: [
