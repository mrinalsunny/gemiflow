 ...
 * - GemiFlow v3 UnifiedSwarmCoordinator
...
// ============================================================================
// V3 Swarm Types (Source Interface from @gemiflow/swarm)
// ============================================================================

/**
 * V3 Topology types (from @gemiflow/swarm)
 */
export type V3TopologyType = 'mesh' | 'hierarchical' | 'centralized' | 'hybrid';

/**
 * V3 Agent Domain types (from @gemiflow/swarm)
 */
export type V3AgentDomain = 'queen' | 'security' | 'core' | 'integration' | 'support';

/**
 * V3 Agent State interface (simplified from @gemiflow/swarm)
 */
...
/**
 * V3 Task Definition interface (simplified from @gemiflow/swarm)
 */
 ...
 * Usage:
 * ```typescript
 * import { SwarmAdapter, createSwarmAdapter } from '@gemiflow/integration';
 *
