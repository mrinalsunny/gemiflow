/**
 * AgenticFlowAgent - GemiFlow Agent with agentic-flow Delegation
 *
 * Per ADR-001: "Use agentic-flow's Agent base class for all agents"
 * This class wraps agentic-flow functionality while adding GemiFlow specifics.
 *
 * This implements the adapter pattern to bridge between:
 * - GemiFlow's agent lifecycle (v3 DDD architecture)
...
/**
 * AgenticFlowAgent - Base class for all GemiFlow v3 agents
 *
 * This class serves as the foundation for all agent types in GemiFlow v3,
