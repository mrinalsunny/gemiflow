...
[![npm version](https://img.shields.io/npm/v/@gemiflow/integration.svg)](https://www.npmjs.com/package/@gemiflow/integration)
[![npm downloads](https://img.shields.io/npm/dm/@gemiflow/integration.svg)](https://www.npmjs.com/package/@gemiflow/integration)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![ADR-001](https://img.shields.io/badge/ADR--001-Compliant-green.svg)](https://github.com/mrinalsunny/gemiflow)

> Deep agentic-flow@alpha integration module for GemiFlow V3 - ADR-001 compliance, code deduplication, SONA adapter, and Flash Attention coordinator.
...
```bash
npm install @gemiflow/integration
...
```typescript
import { AgenticFlowBridge, createAgenticFlowBridge } from '@gemiflow/integration';
...
- [@gemiflow/neural](../neural) - SONA learning module
- [@gemiflow/memory](../memory) - AgentDB memory
- [@gemiflow/performance](../performance) - Benchmarking
