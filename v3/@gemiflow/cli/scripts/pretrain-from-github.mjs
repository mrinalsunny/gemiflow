#!/usr/bin/env node
// pretrain-from-github.mjs — pretrain gemiflow's self-learning system from its
...
const GEMIFLOW_ROOT = resolve(SCRIPT_DIR, '../../../..');
...
async function main() {
  ...
  if (!process.env.BENCH_JSON) {
    console.log(`# Pretrain from gemiflow GitHub history`);
