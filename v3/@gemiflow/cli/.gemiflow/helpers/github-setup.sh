...
# Setup GitHub integration for GemiFlow
...
echo "  - npx gemiflow github swarm"
echo "  - npx gemiflow repo analyze"
echo "  - npx gemiflow pr enhance"
echo "  - npx gemiflow issue triage"
