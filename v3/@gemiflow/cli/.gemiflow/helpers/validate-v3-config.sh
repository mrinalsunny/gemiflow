...
required_files=(
  ".gemiflow/settings.json"
  ".gemiflow/statusline.sh"
  ".gemiflow/helpers/update-v3-progress.sh"
  ".gemiflow/metrics/v3-progress.json"
  ".gemiflow/metrics/performance.json"
  ".gemiflow/security/audit-status.json"
  "package.json"
)
