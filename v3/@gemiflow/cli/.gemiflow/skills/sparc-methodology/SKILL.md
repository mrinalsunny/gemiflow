...
SPARC (Specification, Pseudocode, Architecture, Refinement, Completion) is a systematic development methodology integrated with GemiFlow's multi-agent orchestration capabilities. It provides 17 specialized modes for comprehensive software development, from initial research through deployment and monitoring.
...
npx gemiflow sparc tdd "feature description"

# Batch execution
npx gemiflow sparc batch <mode1,mode2,mode3> "task"

# Pipeline execution
npx gemiflow sparc pipeline "task description"
```

### Method 3: Local Installation

**Best for**: Projects with local gemiflow installation
...
mcp__gemiflow__agent_spawn { type: "architect" }
mcp__gemiflow__agent_spawn { type: "coder" }
mcp__gemiflow__agent_spawn { type: "tester" }
mcp__gemiflow__agent_spawn { type: "reviewer" }
```
...
[Single Message]:
  mcp__gemiflow__agent_spawn { type: "researcher" }
  mcp__gemiflow__agent_spawn { type: "coder" }
  mcp__gemiflow__agent_spawn { type: "tester" }
  TodoWrite { todos: [8-10 todos] }

// ❌ WRONG: Multiple messages
Message 1: mcp__gemiflow__agent_spawn { type: "researcher" }
Message 2: mcp__gemiflow__agent_spawn { type: "coder" }
...
```bash
# Before work
npx gemiflow@alpha hooks pre-task --description "implement auth"

# During work
npx gemiflow@alpha hooks post-edit --file "auth.js"

# After work
npx gemiflow@alpha hooks post-task --task-id "task-123"
```
...
npx gemiflow sparc run researcher "authentication patterns"

# Step 2: Architecture design
npx gemiflow sparc run architect "design auth system"

# Step 3: TDD implementation
npx gemiflow sparc tdd "user authentication feature"

# Step 4: Code review
npx gemiflow sparc run reviewer "review auth implementation"

# Step 5: Documentation
npx gemiflow sparc run documenter "document auth API"
```
...
npx gemiflow sparc run analyzer "investigate bug #456"

# Step 2: Debug systematically
npx gemiflow sparc run debugger "fix memory leak in service X"

# Step 3: Create tests
npx gemiflow sparc run tester "regression tests for bug #456"

# Step 4: Review fix
npx gemiflow sparc run reviewer "validate bug fix"
```
...
npx gemiflow sparc run analyzer "profile API response times"

# Step 2: Identify bottlenecks
npx gemiflow sparc run optimizer "optimize database queries"

# Step 3: Implement improvements
npx gemiflow sparc run coder "implement caching layer"

# Step 4: Benchmark results
npx gemiflow sparc run tester "performance benchmarks"
```
...
npx gemiflow sparc pipeline "e-commerce checkout feature"
...
mcp__gemiflow__context_restore {
...
```javascript
// Analyze repository
mcp__gemiflow__github_repo_analyze {
  repo: "owner/repo",
  analysis_type: "code_quality"
}

// Manage pull requests
mcp__gemiflow__github_pr_manage {
  repo: "owner/repo",
  pr_number: 123,
  action: "review"
}
...
- **NPM Package**: https://www.npmjs.com/package/gemiflow
...
# Run specific mode
npx gemiflow sparc run <mode> "task"

# TDD workflow
npx gemiflow sparc tdd "feature"

# Full pipeline
npx gemiflow sparc pipeline "task"

# Batch execution
npx gemiflow sparc batch <modes> "task"
```
...
// Execute mode
mcp__gemiflow__sparc_mode { mode: "coder", task_description: "..." }

// Monitor progress
mcp__gemiflow__swarm_monitor { interval: 5000 }

// Store in memory
mcp__gemiflow__memory_usage { action: "store", key: "...", value: "..." }
```
