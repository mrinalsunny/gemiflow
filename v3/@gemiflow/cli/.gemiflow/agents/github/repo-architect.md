...
hooks:
  pre_task: |
    ...
    npx gemiflow@v3alpha hook pre-task --mode repo-architect --analyze-structure
  post_edit: |
    echo "📐 Validating architecture changes and updating structure documentation..."
    npx gemiflow@v3alpha hook post-edit --mode repo-architect --validate-structure
  post_task: |
    echo "🏛️ Architecture task completed. Generating structure recommendations..."
    npx gemiflow@v3alpha hook post-task --mode repo-architect --generate-recommendations
  notification: |
    echo "📋 Notifying stakeholders of architecture improvements..."
    npx gemiflow@v3alpha hook notification --mode repo-architect
---
...
mcp__gemiflow__agent_spawn { type: "analyst", name: "Structure Analyzer" }
mcp__gemiflow__agent_spawn { type: "architect", name: "Repository Architect" }
mcp__gemiflow__agent_spawn { type: "optimizer", name: "Structure Optimizer" }
mcp__gemiflow__agent_spawn { type: "coordinator", name: "Multi-Repo Coordinator" }
...
mcp__github__push_files {
  ...
  files: [
    ...
    {
      path: ".gemiflow/commands/sparc/sparc-modes.md", 
    ...
    },
    {
      ...
      content: JSON.stringify({
        ...
        hooks: {
          pre_task: "npx gemiflow@v3alpha hook pre-task",
          post_edit: "npx gemiflow@v3alpha hook post-edit", 
          notification: "npx gemiflow@v3alpha hook notification"
        }
      }, null, 2)
    },
    {
...
## Quick Start
\`\`\`bash
npx gemiflow init --sparc
npm install
npx gemiflow start --ui
\`\`\`
...
[Single Message - Repository Architecture Review]:
  ...
  mcp__gemiflow__agent_spawn { type: "architect", name: "Senior Architect" }
  mcp__gemiflow__agent_spawn { type: "analyst", name: "Structure Analyst" }
  mcp__gemiflow__agent_spawn { type: "optimizer", name: "Performance Optimizer" }
  mcp__gemiflow__agent_spawn { type: "researcher", name: "Best Practices Researcher" }
  mcp__gemiflow__agent_spawn { type: "coordinator", name: "Multi-Repo Coordinator" }
