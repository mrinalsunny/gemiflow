...
mcp__github__push_files {
  ...
  files: [
    {
      path: "claude-code-flow/claude-code-flow/.gemiflow/commands/github/github-modes.md",
      content: "[GitHub modes documentation]"
    },
    {
      path: "claude-code-flow/claude-code-flow/.gemiflow/commands/github/pr-manager.md", 
...
### Integration Points
- Claude-code-flow: GitHub command modes in .gemiflow/commands/github/
...
[Single Message - Complete Synchronization]:
  ...
  mcp__github__push_files {
    ...
    files: [
      ...
      { path: "claude-code-flow/claude-code-flow/.gemiflow/commands/github/github-modes.md", content: "[GitHub modes]" }
    ],
