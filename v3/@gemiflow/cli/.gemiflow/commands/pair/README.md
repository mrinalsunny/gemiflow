...
gemiflow pair --start --agent senior-dev

# Start with verification
gemiflow pair --start --verify --threshold 0.98
```
...
```bash
gemiflow pair --start --mode switch --interval 10m
```
...
gemiflow pair --end --save

# End and generate report
gemiflow pair --end --report
```
...
gemiflow pair --start --git --review-commit
```

### With Testing Frameworks
```bash
# Jest integration
gemiflow pair --start --test-framework jest

# Pytest integration
gemiflow pair --start --test-framework pytest
```
...
Configure pair programming in `.gemiflow/config.json`:
