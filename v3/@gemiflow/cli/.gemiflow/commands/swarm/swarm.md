...
Main swarm orchestration command for GemiFlow V3.
...
## Usage
```bash
npx @gemiflow/cli@latest swarm init --topology hierarchical
npx @gemiflow/cli@latest swarm status  # Only after completion
```
