...
npx gemiflow sparc run analyzer "analyze codebase performance"

# For alpha features
npx gemiflow@alpha sparc run analyzer "analyze codebase performance"
```

### Option 3: Local Installation
```bash
# If gemiflow is installed locally
./gemiflow sparc run analyzer "analyze codebase performance"
```
