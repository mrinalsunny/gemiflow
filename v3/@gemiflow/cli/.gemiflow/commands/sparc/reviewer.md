...
npx gemiflow sparc run reviewer "review pull request #123"

# For alpha features
npx gemiflow@alpha sparc run reviewer "review pull request #123"
```

### Option 3: Local Installation
```bash
# If gemiflow is installed locally
./gemiflow sparc run reviewer "review pull request #123"
```
