...
npx gemiflow sparc run swarm-coordinator "manage development swarm"

# For alpha features
npx gemiflow@alpha sparc run swarm-coordinator "manage development swarm"
```

### Option 3: Local Installation
```bash
# If gemiflow is installed locally
./gemiflow sparc run swarm-coordinator "manage development swarm"
```
