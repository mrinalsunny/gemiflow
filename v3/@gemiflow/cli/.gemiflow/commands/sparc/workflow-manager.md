...
npx gemiflow sparc run workflow-manager "automate deployment"

# For alpha features
npx gemiflow@alpha sparc run workflow-manager "automate deployment"
```

### Option 3: Local Installation
```bash
# If gemiflow is installed locally
./gemiflow sparc run workflow-manager "automate deployment"
```
