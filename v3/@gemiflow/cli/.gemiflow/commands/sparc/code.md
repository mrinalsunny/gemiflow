...
npx gemiflow sparc run code "implement REST API endpoints"

# For alpha features
npx gemiflow@alpha sparc run code "implement REST API endpoints"

# With namespace
npx gemiflow sparc run code "your task" --namespace code

# Non-interactive mode
npx gemiflow sparc run code "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If gemiflow is installed locally
./gemiflow sparc run code "implement REST API endpoints"
```
...
```bash
# Store mode-specific context
npx gemiflow memory store "code_context" "important decisions" --namespace code

# Query previous work
npx gemiflow memory query "code" --limit 5
```
