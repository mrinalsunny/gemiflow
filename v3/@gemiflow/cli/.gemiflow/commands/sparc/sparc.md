...
npx gemiflow sparc run sparc "orchestrate authentication system"

# For alpha features
npx gemiflow@alpha sparc run sparc "orchestrate authentication system"

# With namespace
npx gemiflow sparc run sparc "your task" --namespace sparc

# Non-interactive mode
npx gemiflow sparc run sparc "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If gemiflow is installed locally
./gemiflow sparc run sparc "orchestrate authentication system"
```
...
```bash
# Store mode-specific context
npx gemiflow memory store "sparc_context" "important decisions" --namespace sparc

# Query previous work
npx gemiflow memory query "sparc" --limit 5
```
