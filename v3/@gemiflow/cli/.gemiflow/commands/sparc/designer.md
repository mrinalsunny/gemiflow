...
npx gemiflow sparc run designer "create dashboard UI"

# For alpha features
npx gemiflow@alpha sparc run designer "create dashboard UI"
```

### Option 3: Local Installation
```bash
# If gemiflow is installed locally
./gemiflow sparc run designer "create dashboard UI"
```
