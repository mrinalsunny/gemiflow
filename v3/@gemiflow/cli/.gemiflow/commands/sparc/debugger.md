...
npx gemiflow sparc run debugger "fix authentication issues"

# For alpha features
npx gemiflow@alpha sparc run debugger "fix authentication issues"
```

### Option 3: Local Installation
```bash
# If gemiflow is installed locally
./gemiflow sparc run debugger "fix authentication issues"
```
