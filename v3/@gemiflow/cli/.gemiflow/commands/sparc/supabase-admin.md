...
npx gemiflow sparc run supabase-admin "create user authentication schema"

# For alpha features
npx gemiflow@alpha sparc run supabase-admin "create user authentication schema"

# With namespace
npx gemiflow sparc run supabase-admin "your task" --namespace supabase-admin

# Non-interactive mode
npx gemiflow sparc run supabase-admin "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If gemiflow is installed locally
./gemiflow sparc run supabase-admin "create user authentication schema"
```
...
```bash
# Store mode-specific context
npx gemiflow memory store "supabase-admin_context" "important decisions" --namespace supabase-admin

# Query previous work
npx gemiflow memory query "supabase-admin" --limit 5
```
