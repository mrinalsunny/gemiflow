...
gemiflow verify check --file src/critical.js --threshold 0.99

# Verify and auto-fix issues
gemiflow verify check --directory src/ --auto-fix

# Get JSON output for CI/CD
gemiflow verify check --json > verification.json
```
