...
```bash
npx gemiflow hook pre-edit -f "config/database.js" --validate-syntax
```

### Manual agent assignment

```bash
npx gemiflow hook pre-edit -f "api/users.ts" --auto-assign-agent false
```
...
npx gemiflow hook pre-edit --file "path/to/file.js" --validate-syntax
```
