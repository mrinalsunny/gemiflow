...
Matrix of agent capabilities and their specializations for GemiFlow V3.
...
### Swarm Tools
```
hierarchical-coordinator: mcp__gemiflow__swarm_*, mcp__gemiflow__agent_*
mesh-coordinator: mcp__gemiflow__swarm_*, mcp__gemiflow__coordination_*
adaptive-coordinator: mcp__gemiflow__topology_*, mcp__gemiflow__swarm_*
```

### GitHub Tools
```
pr-manager: mcp__github__*, Bash (gh CLI)
code-review-swarm: mcp__github__*, mcp__gemiflow__swarm_*
release-manager: mcp__github__*, mcp__gemiflow__workflow_*
```
...
npx gemiflow agent spawn -t coder --help

# View agent definition
cat .gemiflow/agents/core/coder.md
```
