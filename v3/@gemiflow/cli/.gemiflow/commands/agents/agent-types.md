---
name: agent-types
description: Complete guide to all 87 available agent types in GemiFlow V3
type: reference
---

# Agent Types Reference

Complete guide to all 87 available agent types in GemiFlow V3.
...
npx gemiflow agent spawn --help

# Spawn any agent
npx gemiflow agent spawn -t <agent-type>
```
