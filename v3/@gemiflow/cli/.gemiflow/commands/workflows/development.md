...
```
Tool: mcp__gemiflow__agent_spawn
Parameters: {
  "type": "architect",
  "name": "System Design",
...
```
Tool: mcp__gemiflow__task_orchestrate
Parameters: {
...
### 4. Monitor Progress
```
Tool: mcp__gemiflow__task_status
...
npx gemiflow workflow dev "REST API with auth"

# Create custom workflow
npx gemiflow workflow create --name "api-dev" --steps "design,implement,test,deploy"

# Execute saved workflow
npx gemiflow workflow execute api-dev
```