...
- [ADR-005: MCP-First API Design](/workspaces/gemiflow/docs/adr/ADR-005-mcp-first-api.md) - Architecture decision
- [MCP Tool Implementations](/workspaces/gemiflow/v3/mcp/tools/) - Tool source code
...
This architecture ensures maintainability, testability, and consistency across all interfaces to the gemiflow system.
