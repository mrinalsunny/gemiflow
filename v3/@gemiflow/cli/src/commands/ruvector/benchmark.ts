...
export const benchmarkCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow ruvector benchmark', description: 'Run default benchmark' },
    { command: 'gemiflow ruvector benchmark --vectors 50000', description: 'Benchmark with 50k vectors' },
    { command: 'gemiflow ruvector benchmark --index ivfflat', description: 'Test IVFFlat index' },
    { command: 'gemiflow ruvector benchmark --dimensions 768 --metric l2', description: 'Custom dimensions and metric' },
  ],
