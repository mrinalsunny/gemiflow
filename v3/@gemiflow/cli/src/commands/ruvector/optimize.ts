...
export const optimizeCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow ruvector optimize --analyze', description: 'Analyze and show recommendations' },
    { command: 'gemiflow ruvector optimize --apply', description: 'Apply optimizations' },
    { command: 'gemiflow ruvector optimize --vacuum', description: 'Run VACUUM ANALYZE' },
    { command: 'gemiflow ruvector optimize --reindex', description: 'Rebuild all indexes' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    try {
      ...
      output.printBox([
        ...
        '',
        'Quick commands:',
        `  gemiflow ruvector optimize --vacuum    # Clean up tables`,
        `  gemiflow ruvector optimize --reindex  # Rebuild indexes`,
        `  gemiflow ruvector optimize --apply    # Apply critical fixes`,
