...
export const storeListCommand: Command = {
  ...
  options: [
    { name: 'registry', short: 'r', type: 'string', description: 'Registry name (default: gemiflow-official)' },
  ...
  examples: [
    { command: 'gemiflow hooks transfer store list', description: 'List all patterns' },
    { command: 'gemiflow hooks transfer store list --category routing', description: 'List routing patterns' },
    { command: 'gemiflow hooks transfer store list --featured', description: 'List featured patterns' },
  ],
...
export const storeSearchCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks transfer store search -q "routing"', description: 'Search for routing patterns' },
    { command: 'gemiflow hooks transfer store search -q "react" --language typescript', description: 'Search with filters' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
export const storeDownloadCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks transfer store download -n seraphine-genesis', description: 'Download pattern' },
    { command: 'gemiflow hooks transfer store download -n seraphine-genesis --import', description: 'Download and import' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
export const storePublishCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks transfer store publish -i patterns.cfp -n my-patterns -d "My patterns" -c routing -t custom', description: 'Publish pattern' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
export const storeInfoCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks transfer store info -n seraphine-genesis', description: 'Show pattern info' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const patternName = (ctx.args[0] || ctx.flags.name) as string;
...
export const storeCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks transfer store list', description: 'List patterns' },
    { command: 'gemiflow hooks transfer store search -q "routing"', description: 'Search patterns' },
    { command: 'gemiflow hooks transfer store download -n seraphine-genesis', description: 'Download pattern' },
    { command: 'gemiflow hooks transfer store publish -i patterns.cfp ...', description: 'Publish pattern' },
  ],
  action: async (): Promise<CommandResult> => {
    output.writeln();
    output.writeln(output.bold('GemiFlow Pattern Store'));
    ...
    output.writeln(output.dim('  gemiflow hooks transfer store list --featured'));
    output.writeln(output.dim('  gemiflow hooks transfer store search -q "routing"'));
    output.writeln(output.dim('  gemiflow hooks transfer store download -n seraphine-genesis'));
