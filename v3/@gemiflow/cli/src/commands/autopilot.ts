...
export const autopilotCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow autopilot status', description: 'Show current state and progress' },
    { command: 'gemiflow autopilot enable', description: 'Enable persistent completion' },
    { command: 'gemiflow autopilot config --max-iterations 100 --timeout 180', description: 'Configure limits' },
    { command: 'gemiflow autopilot predict', description: 'Get recommended next action' },
  ],
  action: async (): Promise<CommandResult> => {
