...
const preEditCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks pre-edit -f src/utils.ts', description: 'Get context before editing' },
    { command: 'gemiflow hooks pre-edit -f src/api.ts -o refactor', description: 'Pre-edit with operation type' }
  ],
...
const postEditCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks post-edit -f src/utils.ts --success true', description: 'Record successful edit' },
    { command: 'gemiflow hooks post-edit -f src/api.ts --success false -o "Type error"', description: 'Record failed edit' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    // Default file to 'unknown' for backward compatibility (env var may be empty)
    const filePath = (ctx.flags.file as string) || ctx.args[0] || 'unknown';
...
const preCommandCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks pre-command -c "rm -rf dist"', description: 'Assess command risk' },
    { command: 'gemiflow hooks pre-command -c "npm install lodash"', description: 'Check package install' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const postCommandCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks post-command -c "npm test" --success true', description: 'Record successful test run' },
    { command: 'gemiflow hooks post-command -c "npm build" --success false -e 1', description: 'Record failed build' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const command = (ctx.flags.command as string) || ctx.args[0];
...
const routeCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks route -t "Fix authentication bug"', description: 'Route task to optimal agent' },
    { command: 'gemiflow hooks route -t "Optimize database queries" -K 5', description: 'Get top 5 suggestions' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const explainCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks explain -t "Fix authentication bug"', description: 'Explain routing decision' },
    { command: 'gemiflow hooks explain -t "Optimize queries" -a coder --verbose', description: 'Verbose explanation for specific agent' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const task = (ctx.flags.task as string) || ctx.args[0];
...
const pretrainCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks pretrain', description: 'Pretrain with embeddings indexing' },
    { command: 'gemiflow hooks pretrain -p ../my-project --depth deep', description: 'Deep analysis of specific project' },
    { command: 'gemiflow hooks pretrain --no-with-embeddings', description: 'Skip embedding indexing' },
    { command: 'gemiflow hooks pretrain --file-types ts,tsx,js', description: 'Index only TypeScript/JS files' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    try {
      ...
      output.writeln(output.dim('  Next step: Run "gemiflow hooks build-agents" to generate optimized configs'));
...
const buildAgentsCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks build-agents', description: 'Build all agent configs' },
    { command: 'gemiflow hooks build-agents --focus security -o ./config/agents', description: 'Build security-focused configs' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const metricsCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks metrics', description: 'View 24h metrics' },
    { command: 'gemiflow hooks metrics --period 7d --v3-dashboard', description: 'V3 metrics for 7 days' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const transferFromProjectCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks transfer from-project -s ../old-project', description: 'Transfer all patterns' },
    { command: 'gemiflow hooks transfer from-project -s ../prod --filter security -m 0.9', description: 'Transfer high-confidence security patterns' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const transferCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks transfer store list', description: 'List patterns from registry' },
    { command: 'gemiflow hooks transfer store search -q routing', description: 'Search patterns' },
    { command: 'gemiflow hooks transfer store download -p seraphine-genesis', description: 'Download pattern' },
    { command: 'gemiflow hooks transfer store publish', description: 'Publish pattern to registry' },
    { command: 'gemiflow hooks transfer from-project -s ../other-project', description: 'Transfer from project' },
  ],
  action: async (): Promise<CommandResult> => {
    ...
    output.writeln();
    output.writeln('Run "gemiflow hooks transfer <subcommand> --help" for details');
    return { success: true };
  }
};
...
const preTaskCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks pre-task -i task-123 -d "Fix auth bug"', description: 'Record task start' },
    { command: 'gemiflow hooks pre-task -i task-456 -d "Implement feature" --auto-spawn', description: 'With auto-spawn' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const postTaskCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks post-task -i task-123 --success true', description: 'Record successful completion' },
    { command: 'gemiflow hooks post-task -i task-456 --success false -q 0.3', description: 'Record failed task' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const sessionEndCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks session-end', description: 'End and save session' },
    { command: 'gemiflow hooks session-end --save-state false', description: 'End without saving' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const sessionRestoreCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks session-restore', description: 'Restore latest session' },
    { command: 'gemiflow hooks session-restore -i session-12345', description: 'Restore specific session' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const intelligenceCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks intelligence --status', description: 'Show intelligence status' },
    { command: 'gemiflow hooks intelligence -m real-time', description: 'Enable real-time mode' },
    { command: 'gemiflow hooks intelligence --train', description: 'Force training cycle' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const workerListCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks worker list', description: 'List all workers' },
    { command: 'gemiflow hooks worker list --active', description: 'Show active instances' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const workerDispatchCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks worker dispatch -t optimize -c src/', description: 'Dispatch optimize worker' },
    { command: 'gemiflow hooks worker dispatch -t audit -p critical', description: 'Security audit with critical priority' },
    { command: 'gemiflow hooks worker dispatch -t testgaps --sync', description: 'Test coverage analysis (sync)' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    try {
      ...
      if (background) {
        output.writeln();
        output.writeln(output.dim(`Check status: gemiflow hooks worker status --id ${result.workerId}`));
      }
...
const workerStatusCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks worker status', description: 'Show running workers' },
    { command: 'gemiflow hooks worker status --id worker_audit_1', description: 'Check specific worker' },
    { command: 'gemiflow hooks worker status --all', description: 'Include completed workers' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const workerDetectCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks worker detect -p "optimize performance"', description: 'Detect triggers in prompt' },
    { command: 'gemiflow hooks worker detect -p "security audit" --auto-dispatch', description: 'Detect and dispatch' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const workerCancelCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks worker cancel --id worker_audit_1', description: 'Cancel specific worker' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const workerId = ctx.flags['id'] as string;
...
const coverageRouteCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks coverage-route -t "fix bug in auth"', description: 'Route with coverage awareness' },
    { command: 'gemiflow hooks coverage-route -t "add tests" --threshold 90', description: 'Route with custom threshold' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const task = (ctx.flags.task as string) || ctx.args[0];
...
const coverageSuggestCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks coverage-suggest -p src/', description: 'Suggest improvements for src/' },
    { command: 'gemiflow hooks coverage-suggest -p src/services --threshold 90', description: 'Stricter threshold' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const coverageGapsCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks coverage-gaps', description: 'List all coverage gaps' },
    { command: 'gemiflow hooks coverage-gaps --critical-only', description: 'Only critical gaps' },
    { command: 'gemiflow hooks coverage-gaps --threshold 90', description: 'Stricter threshold' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const threshold = ctx.flags.threshold as number || 80;
...
const progressHookCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks progress', description: 'Check current progress' },
    { command: 'gemiflow hooks progress -d', description: 'Detailed breakdown' },
    { command: 'gemiflow hooks progress --sync', description: 'Sync progress to file' },
    { command: 'gemiflow hooks progress --summary', description: 'Human-readable summary' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    try {
      ...
      if (sync) {
        ...
        output.writeln(output.dim(`  Persisted to .gemiflow/metrics/v3-progress.json`));
...
const workerCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks worker list', description: 'List all workers' },
    { command: 'gemiflow hooks worker dispatch -t optimize', description: 'Dispatch optimizer' },
    { command: 'gemiflow hooks worker detect -p "test coverage"', description: 'Detect from prompt' },
  ],
  action: async (): Promise<CommandResult> => {
    output.writeln();
    ...
    output.writeln();
    output.writeln('Run "gemiflow hooks worker <subcommand> --help" for details');
...
const statuslineCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks statusline', description: 'Display full statusline' },
    { command: 'gemiflow hooks statusline --json', description: 'JSON output for hooks' },
    { command: 'gemiflow hooks statusline --compact', description: 'Single-line status' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    function getLearningStats() {
      const memoryPaths = [
        ...
        path.join(process.cwd(), '.gemiflow', 'memory.db'),
      ];
      ...
      const sessionsPath = path.join(process.cwd(), '.gemiflow', 'sessions');
    ...
    function getSecurityStatus() {
      const scanResultsPath = path.join(process.cwd(), '.gemiflow', 'security-scans');
      let cvesFixed = 0;
      const totalCves = 3;
    ...
    function getSystemMetrics() {
      ...
      const learningJsonPaths = [
        path.join(process.cwd(), '.gemiflow', 'learning.json'),
        path.join(process.cwd(), '.gemiflow', '.gemiflow', 'learning.json'),
      ...
      if (intelligencePct === 0) {
        ...
        if (fs.existsSync(path.join(process.cwd(), '.gemiflow'))) maturityScore += 15;
        if (fs.existsSync(path.join(process.cwd(), '.gemiflow'))) maturityScore += 15;
        if (fs.existsSync(path.join(process.cwd(), 'CLAUDE.md'))) maturityScore += 10;
        if (fs.existsSync(path.join(process.cwd(), 'gemiflow.config.json'))) maturityScore += 10;
        ...
        if (fs.existsSync(path.join(process.cwd(), '.gemiflow', 'settings.json'))) maturityScore += 10;
    ...
    // Generate lines
    let header = `${c.bold}${c.brightPurple}▊ GemiFlow V3 ${c.reset}`;
    ...
    const settingsPath = path.join(process.cwd(), '.gemiflow', 'settings.json');
    ...
    const dbPaths = [
      ...
      path.join(process.cwd(), '.gemiflow', 'memory', 'agentdb.db'),
    ];
    ...
    if (agentdbStats.vectorCount === 0) {
      const agentdbDirs = [
        path.join(process.cwd(), '.gemiflow', 'agentdb'),
    ...
    const hnswPaths = [
      path.join(process.cwd(), '.gemiflow', 'hnsw'),
    ...
    const vectorsPath = path.join(process.cwd(), '.gemiflow', 'vectors.json');
...
const routeTaskCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks route-task --auto-swarm true', description: 'Route with auto-swarm (v2 compat)' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const sessionStartCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks session-start --auto-configure true', description: 'Start session (v2 compat)' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const tokenOptimizeCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks token-optimize --stats', description: 'Show token savings stats' },
    { command: 'gemiflow hooks token-optimize -q "auth patterns"', description: 'Get compact context' },
    { command: 'gemiflow hooks token-optimize -A 8 --report', description: 'Config for 8 agents + report' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const modelRouteCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks model-route -t "fix typo"', description: 'Route simple task (likely haiku)' },
    { command: 'gemiflow hooks model-route -t "architect auth system"', description: 'Route complex task (likely opus)' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const task = (ctx.flags.task as string) || ctx.args[0];
    if (!task) {
...
const modelOutcomeCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks model-outcome -t "fix typo" -m haiku -o success', description: 'Record successful haiku task' },
    { command: 'gemiflow hooks model-outcome -t "auth system" -m sonnet -o escalated', description: 'Record escalation to opus' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const modelStatsCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks model-stats', description: 'View routing stats' },
    { command: 'gemiflow hooks model-stats --detailed', description: 'Show detailed breakdown' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    try {
      const result = await callMCPTool<{
...
const teammateIdleCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks teammate-idle --auto-assign true', description: 'Auto-assign tasks to idle teammate' },
    { command: 'gemiflow hooks teammate-idle -t worker-1 --check-task-list', description: 'Check tasks for specific teammate' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const taskCompletedCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks task-completed -i task-123 --train-patterns', description: 'Complete task and train patterns' },
    { command: 'gemiflow hooks task-completed -i task-456 --notify-lead --quality 0.95', description: 'Complete with quality score' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const notifyCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks notify -m "Build complete"', description: 'Send info notification' },
    { command: 'gemiflow hooks notify -m "Test failed" -l error', description: 'Send error notification' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
export const hooksCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow hooks pre-edit -f src/utils.ts', description: 'Get context before editing' },
    { command: 'gemiflow hooks route -t "Fix authentication bug"', description: 'Route task to optimal agent' },
    { command: 'gemiflow hooks pretrain', description: 'Bootstrap intelligence from repository' },
    { command: 'gemiflow hooks metrics --v3-dashboard', description: 'View V3 performance metrics' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    output.writeln();
    ...
    output.writeln();
    output.writeln('Usage: gemiflow hooks <subcommand> [options]');
    output.writeln();
    output.writeln('Subcommands:');
    output.printList([
    ...
    output.writeln();
    output.writeln('Run "gemiflow hooks <subcommand> --help" for subcommand help');
    output.writeln();
