...
const routeTaskCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow route task "implement authentication"', description: 'Route task to best agent' },
    { command: 'gemiflow route task "write unit tests" --q-learning', description: 'Use Q-Learning routing' },
    { command: 'gemiflow route task "review code" --agent reviewer', description: 'Force specific agent' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    if (!taskDescription) {
      ...
      output.writeln(output.dim('Usage: gemiflow route task "task description"'));
...
const listAgentsCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow route list-agents', description: 'List all agents' },
    { command: 'gemiflow route agents --json', description: 'List agents as JSON' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const jsonOutput = ctx.flags.json as boolean;
...
const statsCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow route stats', description: 'Show routing statistics' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    const jsonOutput = ctx.flags.json as boolean;
...
const feedbackCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow route feedback -t "implement auth" -a coder -r 0.9', description: 'Positive feedback' },
    { command: 'gemiflow route feedback -t "write tests" -a tester -r -0.5', description: 'Negative feedback' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const resetCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow route reset', description: 'Reset router state' },
    { command: 'gemiflow route reset --force', description: 'Force reset' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const exportCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow route export', description: 'Export Q-table to stdout' },
    { command: 'gemiflow route export -f qtable.json', description: 'Export to file' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const importCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow route import -f qtable.json', description: 'Import Q-table from file' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
const coverageRouteCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow route coverage', description: 'Analyze coverage and suggest routing' },
    { command: 'gemiflow route coverage --suggest', description: 'Get improvement suggestions' },
    { command: 'gemiflow route coverage --gaps', description: 'List coverage gaps by agent' },
    { command: 'gemiflow route coverage -p src/auth -t 90', description: 'Analyze specific path with threshold' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
...
export const routeCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow route "implement feature"', description: 'Route task to best agent' },
    { command: 'gemiflow route "write tests" --q-learning', description: 'Use Q-Learning routing' },
    { command: 'gemiflow route --agent coder "fix bug"', description: 'Force specific agent' },
    { command: 'gemiflow route list-agents', description: 'List available agents' },
    { command: 'gemiflow route stats', description: 'Show routing statistics' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    output.writeln('Usage: gemiflow route <task> [options]');
    output.writeln('       gemiflow route <subcommand>');
    output.writeln();
    ...
    output.writeln(output.dim('Run "gemiflow route <subcommand> --help" for more info'));
