 ...
 *
 * @module @gemiflow/cli/commands/progress
 */
...
export const progressCommand: Command = {
  ...
  examples: [
    {
      command: 'gemiflow progress',
      description: 'Check current progress',
    },
    {
      command: 'gemiflow progress --detailed',
      description: 'Show detailed breakdown',
    },
    {
      command: 'gemiflow progress sync',
      description: 'Sync and persist progress',
    },
    {
      command: 'gemiflow progress watch',
      description: 'Watch for changes',
    },
    {
      command: 'gemiflow progress --json',
