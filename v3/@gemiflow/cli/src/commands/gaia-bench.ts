 ...
 *
 * Runs GAIA benchmark questions through the gemiflow agent loop and
...
const runCommand: Command = {
  ...
  examples: [
    {
      command: 'gemiflow gaia-bench run --level 1 --limit 10 --models claude-haiku-4-5 --output json',
      description: 'Run 10 Level-1 questions with Haiku, JSON output',
    },
    {
      command: 'gemiflow gaia-bench run --level 1 --limit 10 --models claude-haiku-4-5,claude-sonnet-4-6',
      description: 'Compare Haiku vs Sonnet on 10 Level-1 questions',
    },
    {
      command: 'gemiflow gaia-bench run --smoke-only --output json',
      description: 'Quick smoke test (5 fixture questions, no HF token needed)',
    },
    {
      command: 'gemiflow gaia-bench run --level 1 --limit 20 --models claude-haiku-4-5 --voting-attempts 3 --output json',
      description: 'Self-consistency voting: run each question 3x, majority-vote (ADR-135 Track A, +5-10pp expected)',
    },
    {
      command: 'gemiflow gaia-bench run --level 1 --models claude-sonnet-4-6 --hardness-routing --output json',
      description: 'ADR-136 Track Q: auto-route questions to Haiku/Sonnet based on predicted difficulty',
    },
    {
      command: 'gemiflow gaia-bench run --level 1 --models claude-sonnet-4-6 --enable-critic --output json',
      description: 'ADR-135 Track D: adversarial critic reviews each answer before submission (+3-5pp expected)',
    },
    {
      command: 'gemiflow gaia-bench run --level 1 --models claude-sonnet-4-6 --decompose --output json',
      description: 'ADR-135 Track E: decompose complex questions into sub-questions (+5-10pp on multi-step Qs)',
    },
    {
      command: 'gemiflow gaia-bench run --level 1 --models claude-sonnet-4-6 --hardness-routing --enable-critic --planning-interval 4',
...
export const gaiaBenchCommand: Command = {
  ...
  examples: [
    ...
    {
      command: 'gemiflow gaia-bench run --smoke-only',
