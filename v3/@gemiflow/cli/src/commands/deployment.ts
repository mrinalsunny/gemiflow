...
const deployCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow deployment deploy -e prod', description: 'Deploy to production' },
    { command: 'gemiflow deployment deploy --dry-run', description: 'Simulate deployment' },
  ],
...
const statusCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow deployment status', description: 'Show all environments' },
    { command: 'gemiflow deployment status -e prod', description: 'Check production' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    try {
      const state = loadDeploymentState(ctx.cwd);
...
const rollbackCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow deployment rollback -e prod', description: 'Rollback production' },
    { command: 'gemiflow deployment rollback -e prod -v v3.0.0', description: 'Rollback to specific version' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    try {
...
const historyCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow deployment history', description: 'Show all history' },
    { command: 'gemiflow deployment history -e prod', description: 'Production history' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    try {
      const state = loadDeploymentState(ctx.cwd);
...
const environmentsCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow deployment environments', description: 'List environments' },
    { command: 'gemiflow deployment envs -a add -n preview -t staging', description: 'Add environment' },
    { command: 'gemiflow deployment envs -a remove -n preview', description: 'Remove environment' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    try {
...
const logsCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow deployment logs -e prod', description: 'View production logs' },
    { command: 'gemiflow deployment logs -d dep-123', description: 'View specific deployment' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    try {
      const state = loadDeploymentState(ctx.cwd);
...
const releaseCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow deployment release -v 3.5.0', description: 'Release version 3.5.0' },
    { command: 'gemiflow deployment release -v 3.5.0 -d "Major update"', description: 'Release with description' },
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    try {
...
export const deploymentCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow deployment deploy -e prod', description: 'Deploy to production' },
    { command: 'gemiflow deployment status', description: 'Check all environments' },
    { command: 'gemiflow deployment rollback -e prod', description: 'Rollback production' },
    { command: 'gemiflow deployment release -v 3.5.0', description: 'Create a release' },
  ],
  action: async (): Promise<CommandResult> => {
    output.writeln();
    output.writeln(output.bold('GemiFlow Deployment'));
