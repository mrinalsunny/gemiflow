...
export const issuesCommand: Command = {
  ...
  examples: [
    { command: 'gemiflow issues list', description: 'List all claims' },
    { command: 'gemiflow issues claim 123 --agent coder:coder-1', description: 'Claim as agent' },
    { command: 'gemiflow issues handoff 123 --to agent:tester:tester-1', description: 'Handoff to tester' },
    { command: 'gemiflow issues stealable', description: 'List stealable' },
    { command: 'gemiflow issues steal 123 --agent coder:coder-2', description: 'Steal issue' },
    { command: 'gemiflow issues board', description: 'Visual board' },
  ],
