...
export interface InitComponents {
  /** Create .gemiflow/settings.json with hooks */
  settings: boolean;
  /** Copy skills to .gemiflow/skills/ */
  skills: boolean;
  /** Copy commands to .gemiflow/commands/ */
  commands: boolean;
  /** Copy agents to .gemiflow/agents/ */
  agents: boolean;
  /** Create helper scripts in .gemiflow/helpers/ */
  helpers: boolean;
  /** Configure statusline */
  statusline: boolean;
  /** Create MCP configuration */
  mcp: boolean;
  /** Create .gemiflow/ directory (V3 runtime) */
  runtime: boolean;
...
/**
 * Runtime configuration (.gemiflow/)
 */
export interface RuntimeConfig {
  ...
  geminiMdTemplate?: ClaudeMdTemplate;
}
...
export interface InitOptions {
  ...
  /**
   * Skip the user-global ~/.gemiflow/CLAUDE.md "GemiFlow Integration" pointer block.
  ...
  /**
   * #1670 — opt in to writing the `attribution` block in `.gemiflow/settings.json`
