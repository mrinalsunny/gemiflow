 ...
 *
 * Usage:
 *   npx @gemiflow/cli headless --worker <type>
 *   npx @gemiflow/cli headless --daemon
 *   npx @gemiflow/cli headless --benchmark
 *
 * Environment:
 *   GEMIFLOW_HEADLESS=true
...
function showHelp(): void {
  console.log(`
Headless Runtime for GemiFlow V3
...
async function runBenchmarks(): Promise<BenchmarkResults> {
  console.log('=== GemiFlow V3 Performance Benchmarks ===\n');
...
async function showStatus(): Promise<void> {
  console.log('=== GemiFlow V3 System Status ===\n');
  ...
  console.log('\nEnvironment:');
  console.log(`  GEMIFLOW_HEADLESS: ${process.env.GEMIFLOW_HEADLESS || 'not set'}`);
...
async function main(): Promise<void> {
  ...
  process.env.GEMIFLOW_HEADLESS = 'true';
