...
async function main() {
  ...
  if (failed === 0) {
    ...
    console.log('    npx @gemiflow/cli patterns list');
    console.log('    npx @gemiflow/cli patterns list --featured');
    console.log('    npx @gemiflow/cli patterns search -q "agent"');
    console.log('    npx @gemiflow/cli patterns info -n <pattern-id>');
    console.log('');
  }
