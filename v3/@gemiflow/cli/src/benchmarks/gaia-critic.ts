 ...
 *  - Update plugins/gemiflow-workflows/commands/gaia-run.md with --enable-critic flag.
 *  - Update plugins/gemiflow-workflows/skills/gaia-debugging/SKILL.md: add critic
