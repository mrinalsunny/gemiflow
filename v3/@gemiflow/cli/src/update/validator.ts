...
// Known compatibility matrix between @gemiflow packages
const COMPATIBILITY_MATRIX: Record<string, Record<string, PackageCompatibility>> = {
  '@gemiflow/cli': {
    '@gemiflow/embeddings': { minVersion: '3.0.0-alpha.1' },
    '@gemiflow/security': { minVersion: '3.0.0-alpha.1' },
    '@gemiflow/integration': { minVersion: '3.0.0-alpha.1' },
  },
  '@gemiflow/embeddings': {
    '@gemiflow/cli': { minVersion: '3.0.0-alpha.50' },
  },
  '@gemiflow/integration': {
    '@gemiflow/cli': { minVersion: '3.0.0-alpha.70' },
