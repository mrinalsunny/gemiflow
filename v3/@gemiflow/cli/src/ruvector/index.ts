/**
 * RuVector Integration Module for GemiFlow CLI
 *
 ...
 *
 * @module @gemiflow/cli/ruvector
 */

export { QLearningRouter, createQLearningRouter, type QLearningRouterConfig, type RouteDecision } from './q-learning-router.js';
// #1773 item 4 — moe-router migrated to @gemiflow/neural. Direct
// consumers (hooks-tools.ts) import from '@gemiflow/neural' explicitly;
...
// #1773 item 4 — flash-attention migrated to @gemiflow/neural. Direct
// consumers (hooks-tools.ts, neural-tools.ts) import from '@gemiflow/neural'
