...
export const performanceTools: MCPTool[] = [
  {
    ...
    description: 'Generate performance report Use when native shell timing (`time`, `hyperfine`) is wrong because you want GemiFlow-aware benchmarks — HNSW search latency, breaker decisions/sec, MCP response p50/p95, embeddings throughput. For OS-level process profiling, native shell + perf are fine.',
  ...
  },
  {
    ...
    description: 'Detect performance bottlenecks Use when native shell timing (`time`, `hyperfine`) is wrong because you want GemiFlow-aware benchmarks — HNSW search latency, breaker decisions/sec, MCP response p50/p95, embeddings throughput. For OS-level process profiling, native shell + perf are fine.',
    category: 'performance',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Run performance benchmarks Use when native shell timing (`time`, `hyperfine`) is wrong because you want GemiFlow-aware benchmarks — HNSW search latency, breaker decisions/sec, MCP response p50/p95, embeddings throughput. For OS-level process profiling, native shell + perf are fine.',
    category: 'performance',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Profile specific component or operation Use when native shell timing (`time`, `hyperfine`) is wrong because you want GemiFlow-aware benchmarks — HNSW search latency, breaker decisions/sec, MCP response p50/p95, embeddings throughput. For OS-level process profiling, native shell + perf are fine.',
    category: 'performance',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Apply performance optimizations Use when native shell timing (`time`, `hyperfine`) is wrong because you want GemiFlow-aware benchmarks — HNSW search latency, breaker decisions/sec, MCP response p50/p95, embeddings throughput. For OS-level process profiling, native shell + perf are fine.',
    category: 'performance',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Get detailed performance metrics Use when native shell timing (`time`, `hyperfine`) is wrong because you want GemiFlow-aware benchmarks — HNSW search latency, breaker decisions/sec, MCP response p50/p95, embeddings throughput. For OS-level process profiling, native shell + perf are fine.',
    category: 'performance',
    inputSchema: {
      type: 'object',
      properties: {
