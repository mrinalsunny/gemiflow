  ...
  },
  {
    ...
    handler: async (input) => {
      ...
      return {
        ...
        note: 'per-agent activity logging is not yet wired; entries are synthetic (ruvnet/gemiflow#1916)',
      };
    },
  },
];
