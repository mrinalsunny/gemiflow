...
export const githubTools: MCPTool[] = [
  {
    ...
    description: 'Analyze a GitHub repository Use when native Bash / file tools are wrong because this MCP tool exposes GemiFlow-specific state or controllers that have no shell equivalent. For tasks that fit a one-line native command, prefer that.',
    category: 'github',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Manage pull requests Use when native Bash / file tools are wrong because this MCP tool exposes GemiFlow-specific state or controllers that have no shell equivalent. For tasks that fit a one-line native command, prefer that.',
    category: 'github',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Track and manage issues Use when native Bash / file tools are wrong because this MCP tool exposes GemiFlow-specific state or controllers that have no shell equivalent. For tasks that fit a one-line native command, prefer that.',
    category: 'github',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  },
  {
    ...
    description: 'Manage GitHub Actions workflows Use when native Bash / file tools are wrong because this MCP tool exposes GemiFlow-specific state or controllers that have no shell equivalent. For tasks that fit a one-line native command, prefer that.',
    category: 'github',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  {
    name: 'github_metrics',
    description: 'Get repository metrics and statistics Use when native Bash / file tools are wrong because this MCP tool exposes GemiFlow-specific state or controllers that have no shell equivalent. For tasks that fit a one-line native command, prefer that.',
    category: 'github',
    inputSchema: {
      type: 'object',
      properties: {
