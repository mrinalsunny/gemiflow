...
async function demo() {
  ...
  if (pluginCreator) {
    ...
    console.log('   $ gemiflow plugins install -n plugin-creator');
    console.log('');
  }
  ...
  console.log('   $ gemiflow plugins list              # List all plugins');
  console.log('   $ gemiflow plugins list --official   # Official only');
  console.log('   $ gemiflow plugins search -q neural  # Search plugins');
  console.log('   $ gemiflow plugins info -n plugin-creator');
  console.log('   $ gemiflow plugins install -n plugin-creator');
  console.log('');
}
