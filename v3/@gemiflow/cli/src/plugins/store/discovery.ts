...
export const DEFAULT_PLUGIN_STORE_CONFIG: PluginStoreConfig = {
  registries: [
    {
      ...
      description: 'Official GemiFlow plugin registry',
  ...
  defaultRegistry: 'gemiflow-official',
  gateway: 'https://gateway.pinata.cloud',
  timeout: 30000,
  cacheDir: '.gemiflow/plugins/cache',
...
export class PluginDiscoveryService {
  ...
  private async createDemoRegistryAsync(registry: KnownPluginRegistry): Promise<PluginDiscoveryResult> {
    ...
    const demoRegistry: PluginRegistry = {
      ...
      totalDownloads: plugins.reduce((sum, p) => sum + p.downloads, 0),
      totalAuthors: 1,
      featured: ['@gemiflow/plugin-iot-cognitum', '@gemiflow/plugin-agent-federation', '@gemiflow/plugin-agentic-qe', '@gemiflow/plugin-prime-radiant', '@gemiflow/security', '@gemiflow/claims', '@gemiflow/teammate-plugin'],
      trending: ['@gemiflow/plugin-iot-cognitum', '@gemiflow/plugin-agent-federation', '@gemiflow/plugin-agentic-qe', '@gemiflow/plugin-prime-radiant'],
      newest: ['@gemiflow/plugin-iot-cognitum', '@gemiflow/plugin-agent-federation', '@gemiflow/plugin-agentic-qe', '@gemiflow/plugin-prime-radiant'],
      official: ['@gemiflow/plugin-iot-cognitum', '@gemiflow/plugin-agent-federation', '@gemiflow/plugin-agentic-qe', '@gemiflow/plugin-prime-radiant', '@gemiflow/security', '@gemiflow/claims'],
      compatibilityMatrix: [
        { pluginId: '@gemiflow/neural', pluginVersion: '3.0.0', gemiflowVersions: ['3.x'], tested: true },
        { pluginId: '@gemiflow/security', pluginVersion: '3.0.0', gemiflowVersions: ['3.x'], tested: true },
      ],
    };
    ...
    return [
      {
        ...
        dependencies: [{ name: '@gemiflow/core', version: '^3.0.0' }],
        type: 'core',
      ...
      {
        id: '@gemiflow/security',
        name: '@gemiflow/security',
        ...
        trustLevel: 'official',
        securityAudit: {
          auditor: 'gemiflow-security-team',
      ...
      {
        id: '@gemiflow/embeddings',
        name: '@gemiflow/embeddings',
        ...
        mingemiflowVersion: '3.0.0',
        dependencies: [
          { name: '@gemiflow/core', version: '^3.0.0' },
      ...
      {
        id: '@gemiflow/performance',
        name: '@gemiflow/performance',
      ...
      },
      {
        ...
        description: 'Analytics and metrics visualization for GemiFlow operations',
        version: '1.2.0',
      ...
      {
        id: '@gemiflow/plugins',
        name: '@gemiflow/plugins',
        displayName: 'Plugin SDK',
        description: 'Unified Plugin SDK for GemiFlow V3 - Worker, Hook, and Provider Integration. Create, test, and publish GemiFlow plugins.',
      ...
      {
        id: '@gemiflow/plugin-prime-radiant',
        name: '@gemiflow/plugin-prime-radiant',
      ...
      {
        id: '@gemiflow/plugin-healthcare-clinical',
      ...
      {
        id: '@gemiflow/plugin-financial-risk',
      ...
      {
        id: '@gemiflow/plugin-legal-contracts',
        name: '@gemiflow/plugin-legal-contracts',
      ...
      {
        id: '@gemiflow/plugin-code-intelligence',
      ...
      {
        id: '@gemiflow/plugin-test-intelligence',
        name: '@gemiflow/plugin-test-intelligence',
      ...
      {
        id: '@gemiflow/plugin-perf-optimizer',
      ...
      {
        id: '@gemiflow/plugin-neural-coordination',
      ...
      {
        id: '@gemiflow/plugin-quantum-optimizer',
      ...
      {
        id: '@gemiflow/plugin-hyperbolic-reasoning',
        name: '@gemiflow/plugin-hyperbolic-reasoning',
      ...
      {
        id: '@gemiflow/plugin-gastown-bridge',
      ...
      {
        id: '@gemiflow/plugin-agent-federation',
        name: '@gemiflow/plugin-agent-federation',
        ...
        mingemiflowVersion: '3.0.0',
        dependencies: [{ name: '@gemiflow/security', version: '^3.0.0' }],
        type: 'integration',
      ...
      {
        id: '@gemiflow/plugin-iot-cognitum',
        name: '@gemiflow/plugin-iot-cognitum',
        displayName: 'IoT Cognitum',
        description: 'Cognitum Seed device-agent bridge — treat every Seed as a GemiFlow agent with 5-tier trust scoring, Ed25519 witness chains, mesh networking, and fleet management.',
        version: '1.0.0-alpha.1',
        ...
        mingemiflowVersion: '3.0.0',
        dependencies: [
          { name: '@gemiflow/shared', version: '^3.0.0' },
      ...
      // Teammate Plugin - Gemini CLI v2.1.19+ integration
      {
        id: '@gemiflow/teammate-plugin',
        name: '@gemiflow/teammate-plugin',
        displayName: 'Teammate Plugin',
        description: 'Native TeammateTool integration for Gemini CLI v2.1.19+. Multi-agent team orchestration with plan approval workflows, delegation, messaging, and BMSSP-optimized topology routing. 21 MCP tools.',
        version: '1.0.0-alpha.1',
        ...
        tags: ['teammate', 'gemini-cli', 'multi-agent', 'swarm', 'orchestration', 'bmssp'],
        keywords: ['teammate', 'gemini-cli', 'multi-agent'],
        downloads: 0,
        rating: 0,
        ratingCount: 0,
        lastUpdated: baseTime,
  ...
  private async getDemoPluginsWithStats(): Promise<PluginEntry[]> {
    ...
    const realNpmPackages = [
      ...
      '@gemiflow/plugin-financial-risk',
      ...
      // Gas Town Bridge
      '@gemiflow/plugin-gastown-bridge',
      // Agent Federation
      '@gemiflow/plugin-agent-federation',
      // IoT Cognitum
      '@gemiflow/plugin-iot-cognitum',
    ];
