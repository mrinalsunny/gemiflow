...
// Optional @gemiflow sibling packages (installed separately)
// Using permissive `any` types since these are runtime-resolved optional deps
declare module '@gemiflow/embeddings' {
  const mod: any;
  export default mod;
...
declare module '@gemiflow/aidefence' {
