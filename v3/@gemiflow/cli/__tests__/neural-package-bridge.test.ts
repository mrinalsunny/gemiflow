/**
 * @gemiflow/neural package bridge — Phase 1 convergence smoke (#1773).
 *
 ...
 *
 * Direct package shape testing happens in @gemiflow/neural's own test
...
describe('@gemiflow/neural package bridge (#1773 Phase 1)', () => {
  beforeEach(() => {
    resetNeuralPackageBridge();
  });
  ...
  it('getNeuralPackageStats returns the documented shape OR null', async () => {
    ...
    if (stats) {
      // Documented shape per @gemiflow/neural NeuralLearningSystem.getStats()
