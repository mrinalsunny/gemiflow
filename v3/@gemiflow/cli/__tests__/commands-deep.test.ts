...
describe('Init System', () => {
  describe('DEFAULT_INIT_OPTIONS', () => {
    it('should have all components enabled by default', () => {
      ...
      expect(DEFAULT_INIT_OPTIONS.components.geminiMd).toBe(true);
    });
  ...
  describe('FULL_INIT_OPTIONS', () => {
    it('should have all components enabled', () => {
      ...
      expect(comps.geminiMd).toBe(true);
    });
    ...
    it('should have all MCP servers enabled', () => {
      expect(FULL_INIT_OPTIONS.mcp.gemiflow).toBe(true);
  ...
  describe('generateSettings', () => {
    ...
    it('should include gemiflow v3 settings', () => {
      const settings = generateSettings(DEFAULT_INIT_OPTIONS) as Record<string, unknown>;
      expect(settings.gemiflow).toBeDefined();
      const cf = settings.gemiflow as Record<string, unknown>;
  ...
  describe('generateClaudeMd', () => {
    ...
    it('should contain the GemiFlow header', () => {
      const md = generateClaudeMd(DEFAULT_INIT_OPTIONS);
      expect(md).toContain('# GemiFlow');
    });
