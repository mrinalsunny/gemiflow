...
```bash
# Run all CLI tests
npm test -- v3/@gemiflow/cli/__tests__/

# Run specific test file
npm test -- v3/@gemiflow/cli/__tests__/cli.test.ts

# Run with coverage
npm test -- v3/@gemiflow/cli/__tests__/ --coverage

# Run in watch mode
npm test -- v3/@gemiflow/cli/__tests__/ --watch
```
