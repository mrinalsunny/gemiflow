...
Environment Variables:
  GEMIFLOW_STATUSLINE_REFRESH   Refresh interval in ms
  GEMIFLOW_SHOW_HOOKS_METRICS   Show hooks metrics (true/false)
  GEMIFLOW_SHOW_SWARM_ACTIVITY  Show swarm activity (true/false)
  GEMIFLOW_SHOW_PERFORMANCE     Show performance targets (true/false)
...
`);
  ...
  const generator = new StatuslineGenerator({
    enabled: true,
    refreshOnHook: true,
    showHooksMetrics: process.env.GEMIFLOW_SHOW_HOOKS_METRICS !== 'false',
    showSwarmActivity: process.env.GEMIFLOW_SHOW_SWARM_ACTIVITY !== 'false',
    showPerformance: process.env.GEMIFLOW_SHOW_PERFORMANCE !== 'false',
  });
