...
[![npm version](https://img.shields.io/npm/v/@gemiflow/hooks.svg)](https://www.npmjs.com/package/@gemiflow/hooks)
[![npm downloads](https://img.shields.io/npm/dm/@gemiflow/hooks.svg)](https://www.npmjs.com/package/@gemiflow/hooks)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.3+-blue.svg)](https://www.typescriptlang.org/)
[![Node.js](https://img.shields.io/badge/Node.js-20+-green.svg)](https://nodejs.org/)

> Event-driven lifecycle hooks with ReasoningBank learning integration for GemiFlow V3

The `@gemiflow/hooks` package provides a comprehensive hooks system for intercepting and extending GemiFlow operations. It enables intelligent task routing, pattern learning, background metrics collection, and real-time statusline integration.
...
# Using pnpm
pnpm add @gemiflow/hooks

# Using yarn
yarn add @gemiflow/hooks
```
...
```typescript
import { initializeHooks } from '@gemiflow/hooks';
...
```typescript
import { hooksMCPTools, getHooksTool } from '@gemiflow/hooks';
...
gemiflow hooks worker detect --prompt "deep dive into auth" --auto-dispatch --min-confidence 0.6
...
|----------|-------------|---------|
| `GEMIFLOW_HOOK_TIMEOUT` | Hook execution timeout (ms) | `5000` |
| `GEMIFLOW_REASONINGBANK_ENABLED` | Enable ReasoningBank | `true` |
| `GEMIFLOW_HOOKS_NAMESPACE` | Learning namespace | `hooks-learning` |
| `GEMIFLOW_HOOKS_LOG_LEVEL` | Logging level | `info` |
| `GEMIFLOW_SHOW_HOOKS_METRICS` | Show hooks in statusline | `true` |
...
- [@gemiflow/shared](../shared) - Shared utilities and types
- [@gemiflow/neural](../neural) - Neural network and SONA learning
- [@gemiflow/swarm](../swarm) - Multi-agent coordination
- [@gemiflow/memory](../memory) - AgentDB memory system
