...
```typescript
import { createEventBus } from '@gemiflow/shared/core';
import { createHookRegistry, createHookExecutor } from '@gemiflow/shared/hooks';
import { EventStore } from '@gemiflow/shared/events';
...
```typescript
import { HookEvent, HookContext } from '@gemiflow/shared/hooks';
...
import { Plugin } from '@gemiflow/shared';
import { HookEvent, HookPriority } from '@gemiflow/shared/hooks';
...
```typescript
// v3/@gemiflow/shared/src/mcp/tools/hooks.ts
