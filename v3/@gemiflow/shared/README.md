...
[![npm version](https://img.shields.io/npm/v/@gemiflow/shared.svg)](https://www.npmjs.com/package/@gemiflow/shared)
...
import { ... } from '@gemiflow/shared';

// Submodule exports (for tree-shaking or specific imports)
import { ... } from '@gemiflow/shared/types';      // Type definitions
import { ... } from '@gemiflow/shared/core';       // Config, interfaces, orchestrator
import { ... } from '@gemiflow/shared/events';     // Event sourcing (ADR-007)
import { ... } from '@gemiflow/shared/hooks';      // Hooks system
import { ... } from '@gemiflow/shared/mcp';        // MCP server infrastructure
import { ... } from '@gemiflow/shared/security';   // Security utilities
import { ... } from '@gemiflow/shared/resilience'; // Retry, circuit breaker, rate limiter
```
...
```typescript
import { EventBus, EventCoordinator } from '@gemiflow/shared/events';
...
```typescript
import { HooksManager, Hook } from '@gemiflow/shared/hooks';
...
```typescript
import { HealthMonitor, HealthCheck } from '@gemiflow/shared/core';
...
This package is a dependency of all other @gemiflow modules:

- [@gemiflow/cli](../cli) - CLI module
- [@gemiflow/security](../security) - Security & validation
- [@gemiflow/memory](../memory) - AgentDB & HNSW indexing
- [@gemiflow/neural](../neural) - SONA learning & RL algorithms
- [@gemiflow/performance](../performance) - Benchmarking & optimization
- [@gemiflow/swarm](../swarm) - 15-agent coordination
- [@gemiflow/integration](../integration) - agentic-flow@alpha bridge
- [@gemiflow/testing](../testing) - TDD framework & fixtures
- [@gemiflow/deployment](../deployment) - Release management
- [@gemiflow/embeddings](../embeddings) - Embedding service
- [@gemiflow/hooks](../hooks) - Hooks system
