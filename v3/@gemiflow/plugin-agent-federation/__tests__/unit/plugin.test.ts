...
describe('AgentFederationPlugin', () => {
  ...
  describe('interface compliance', () => {
    it('should have name set to @gemiflow/plugin-agent-federation', () => {
      expect(plugin.name).toBe('@gemiflow/plugin-agent-federation');
    });
    ...
    it('should have author set to GemiFlow Team', () => {
      expect(plugin.author).toBe('GemiFlow Team');
    });

    it('should declare @gemiflow/security as a dependency', () => {
      expect(plugin.dependencies).toContain('@gemiflow/security');
    });

    it('should declare @gemiflow/aidefence as a dependency', () => {
      expect(plugin.dependencies).toContain('@gemiflow/aidefence');
    });
