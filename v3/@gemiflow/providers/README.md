...
[![npm version](https://img.shields.io/npm/v/@gemiflow/providers.svg)](https://www.npmjs.com/package/@gemiflow/providers)
...
```bash
npm install @gemiflow/providers
```

## Quick Start

```typescript
import { createProviderManager } from '@gemiflow/providers';
...
```typescript
import { ProviderManager, createProviderManager } from '@gemiflow/providers';
...
- [@gemiflow/embeddings](../embeddings) - Embedding generation
- [@gemiflow/memory](../memory) - Vector storage and retrieval
