...
const TEST_PROMPT = 'Say "Hello from GemiFlow V3!" Be brief.';
...
async function testOpenRouter() {
  ...
  const provider = new OpenAIProvider({
    config: {
      ...
      providerOptions: {
        headers: {
          'HTTP-Referer': 'https://gemiflow.dev',
          'X-Title': 'GemiFlow V3 Test',
        },
      },
    },
    logger: consoleLogger,
...
async function main() {
  console.log('╔════════════════════════════════════════════════╗');
  console.log('║     GemiFlow V3 - Provider Test Suite       ║');
  console.log('╚════════════════════════════════════════════════╝');
