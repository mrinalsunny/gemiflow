// @ts-nocheck - CLI integration requires the full @gemiflow/cli package
/**
...
const claimCommand: Command = {
  ...
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    if (!issueId) {
      ...
      output.printInfo('Usage: gemiflow issues claim <issueId>');
      return { success: false, exitCode: 1 };
    }
...
const releaseCommand: Command = {
  ...
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    if (!issueId) {
      output.printError('Issue ID is required');
      output.printInfo('Usage: gemiflow issues release <issueId>');
      return { success: false, exitCode: 1 };
    }
...
const handoffCommand: Command = {
  ...
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    if (!issueId) {
      output.printError('Issue ID is required');
      output.printInfo('Usage: gemiflow issues handoff <issueId> --to <target>');
      return { success: false, exitCode: 1 };
    }
...
const statusCommand: Command = {
  ...
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    if (!issueId) {
      output.printError('Issue ID is required');
      output.printInfo('Usage: gemiflow issues status <issueId> [options]');
      return { success: false, exitCode: 1 };
    }
...
const stealableCommand: Command = {
  ...
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    try {
      ...
      output.writeln();
      output.printInfo('Use "gemiflow issues steal <issueId>" to take over an issue');
...
const stealCommand: Command = {
  ...
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    if (!issueId) {
      output.printError('Issue ID is required');
      output.printInfo('Usage: gemiflow issues steal <issueId>');
      return { success: false, exitCode: 1 };
    }
...
const markStealableCommand: Command = {
  ...
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    if (!issueId) {
      output.printError('Issue ID is required');
      output.printInfo('Usage: gemiflow issues mark-stealable <issueId>');
      return { success: false, exitCode: 1 };
    }
...
const contestCommand: Command = {
  ...
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    if (!issueId) {
      output.printError('Issue ID is required');
      output.printInfo('Usage: gemiflow issues contest <issueId> --reason "..."');
      return { success: false, exitCode: 1 };
    }
...
export const issuesCommand: Command = {
  ...
  options: [],
  examples: [
    { command: 'gemiflow issues list --available', description: 'List unclaimed issues' },
    { command: 'gemiflow issues list --mine', description: 'List my claims' },
    { command: 'gemiflow issues claim GH-123', description: 'Claim an issue' },
    { command: 'gemiflow issues release GH-123', description: 'Release a claim' },
    { command: 'gemiflow issues handoff GH-123 --to agent:coder-1', description: 'Request handoff to agent' },
    { command: 'gemiflow issues handoff GH-123 --to human:alice', description: 'Request handoff to human' },
    { command: 'gemiflow issues status GH-123 --blocked "Waiting for API"', description: 'Mark as blocked' },
    { command: 'gemiflow issues status GH-123 --review-requested', description: 'Request review' },
    { command: 'gemiflow issues board', description: 'View who is working on what' },
    { command: 'gemiflow issues stealable', description: 'List stealable issues' },
    { command: 'gemiflow issues steal GH-123', description: 'Steal an issue' },
    { command: 'gemiflow issues mark-stealable GH-123', description: 'Mark my claim as stealable' },
    { command: 'gemiflow issues contest GH-123 -r "I was actively working on it"', description: 'Contest a steal' },
    { command: 'gemiflow issues load', description: 'View agent load distribution' },
    { command: 'gemiflow issues load --agent coder-1', description: 'View specific agent load' },
    { command: 'gemiflow issues rebalance --dry-run', description: 'Preview rebalancing' },
    { command: 'gemiflow issues rebalance', description: 'Trigger swarm rebalancing' }
  ],
  action: async (ctx: CommandContext): Promise<CommandResult> => {
    ...
    output.writeln();
    output.writeln('Usage: gemiflow issues <subcommand> [options]');
    output.writeln();
    ...
    output.writeln();
    output.writeln('Run "gemiflow issues <subcommand> --help" for subcommand help');
