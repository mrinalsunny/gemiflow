...
[![npm version](https://img.shields.io/npm/v/@gemiflow/claims.svg)](https://www.npmjs.com/package/@gemiflow/claims)
[![npm downloads](https://img.shields.io/npm/dm/@gemiflow/claims.svg)](https://www.npmjs.com/package/@gemiflow/claims)
...
```bash
npm install @gemiflow/claims
```

Or install via GemiFlow CLI:

```bash
npx gemiflow plugins install @gemiflow/claims
```
...
```typescript
import { ClaimsService } from '@gemiflow/claims';
...
```bash
# Claim an issue
npx gemiflow claims claim --issue ISSUE-123 --claimant "human:alice"

# Release a claim
npx gemiflow claims release --issue ISSUE-123

# View claims board
npx gemiflow claims board

# List stealable issues
npx gemiflow claims stealable

# Rebalance workload
npx gemiflow claims rebalance --dry-run
```
