/**
 * @gemiflow/testing - MCP Fixtures
 *
 * Comprehensive mock MCP tools, contexts, and server configurations for testing.
 * Supports all MCP protocol operations and GemiFlow tool integrations.
 *
...
/**
 * Pre-defined MCP tools for GemiFlow
 */
