...
describe('V2 API Compatibility', () => {
  ...
  describe('Import Path Aliases', () => {
    ...
    it('should resolve gemiflow/hive-mind to @gemiflow/swarm', () => {
      const resolved = mockRegistry.resolveImport('gemiflow/hive-mind');

      expect(resolved).toBe('@gemiflow/swarm');
    });

    it('should resolve gemiflow/memory to @gemiflow/memory', () => {
      const resolved = mockRegistry.resolveImport('gemiflow/memory');

      expect(resolved).toBe('@gemiflow/memory');
    });
