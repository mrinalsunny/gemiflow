...
[![npm version](https://img.shields.io/npm/v/@gemiflow/testing.svg)](https://www.npmjs.com/package/@gemiflow/testing)
...
```bash
npm install @gemiflow/testing vitest --save-dev
```
...
```typescript
import { createMockClock, measureTime } from '@gemiflow/testing';
...
```typescript
import { createTestEmitter } from '@gemiflow/testing';
...
```typescript
import { MockAgentDB } from '@gemiflow/testing';
...
```typescript
import { MockSwarmCoordinator } from '@gemiflow/testing';
...
```typescript
import { MockMCPClient, createStandardMockMCPClient } from '@gemiflow/testing';
...
```typescript
import { registerCustomMatchers } from '@gemiflow/testing';
...
```typescript
import { setupV3Tests, configureTestEnvironment } from '@gemiflow/testing';
...
```typescript
import { createSetupContext, createTestScope } from '@gemiflow/testing';
...
```typescript
import { createPerformanceTestHelper } from '@gemiflow/testing';
...
```typescript
import { assertV3PerformanceTargets, TEST_CONFIG } from '@gemiflow/testing';
