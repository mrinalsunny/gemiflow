...
[![npm version](https://img.shields.io/npm/v/@gemiflow/security.svg)](https://www.npmjs.com/package/@gemiflow/security)
[![npm downloads](https://img.shields.io/npm/dm/@gemiflow/security.svg)](https://www.npmjs.com/package/@gemiflow/security)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![TypeScript](https://img.shields.io/badge/TypeScript-5.0+-blue.svg)](https://www.typescriptlang.org/)
[![Security Audit](https://img.shields.io/badge/Security-Audited-green.svg)](https://github.com/mrinalsunny/gemiflow)

> Comprehensive security module for GemiFlow V3 - CVE fixes, input validation, path security, and secure credential management.
...
```typescript
import { PasswordHasher, createPasswordHasher } from '@gemiflow/security';
...
```typescript
import { CredentialGenerator, generateCredentials } from '@gemiflow/security';
...
```typescript
import { SafeExecutor, createDevelopmentExecutor } from '@gemiflow/security';
...
```typescript
import { PathValidator, createProjectPathValidator } from '@gemiflow/security';
...
// Sanitize HTML
import { sanitizeHtml } from '@gemiflow/security';
...
```typescript
import { TokenGenerator, quickGenerate } from '@gemiflow/security';
...
```typescript
import { auditSecurityConfig } from '@gemiflow/security';
...
- [@gemiflow/swarm](../swarm) - Swarm coordination (secure agent spawning)
