 ...
 *
 * Implements P1 of ADR-145 (mrinalsunny/gemiflow#2254): Stage-1 Ed25519 signature
 ...
 * Threat model
 * ------------
 * GemiFlow's plugin install path fetches manifests from IPFS via Pinata with
 ...
 * - Backwards compatible: default mode is warn-only. `GEMIFLOW_STRICT_PLUGINS=true`
...
export interface TrustAnchor {
  ...
  /** Optional plugin id glob this anchor is authoritative for (e.g. `@gemiflow/*`). */
