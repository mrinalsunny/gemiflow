 ...
 *
 * @module @gemiflow/memory/learning-bridge
 */
...
export interface LearningBridgeConfig {
   ...
   * When provided, this replaces the default dynamic import of @gemiflow/neural.
...
export class LearningBridge extends EventEmitter {
  ...
  private async loadNeural(): Promise<void> {
    try {
      ...
      const mod = await import('@gemiflow/neural' as string);
      ...
      // @gemiflow/neural not installed or failed to initialize.
