/**
 * @gemiflow/memory - V3 Unified Memory System
 *
 ...
 *
 * @module @gemiflow/memory
 *
 * @example
 * ```typescript
 * import { UnifiedMemoryService, query, QueryTemplates } from '@gemiflow/memory';
 *
 ...
 *   continue to work through `@gemiflow/memory@3.0.0-rc`. Both names refer
 *   to the same class.
 *
 ...
 *
 * `MemoryService` is the preferred name as of `@gemiflow/memory@3.0.0-alpha.18`.
 ...
 * `import type { MemoryService } from '@gemiflow/memory'` works alongside the
 * value import.
 */
