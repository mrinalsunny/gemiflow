...
| | |
|---|---|
| 🎯 **Plain-English goals** | Describe an outcome — GemiFlow extracts success criteria, constraints, and implicit preconditions |
...
The widget exposes a global `window.GemiFlowResearchWidget` with `init(containerId)` and `version` for programmatic control. See [`docs/WIDGET-INTEGRATION.md`](docs/WIDGET-INTEGRATION.md) for the full integration guide.
