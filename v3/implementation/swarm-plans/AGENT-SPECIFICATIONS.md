...
spawn_command: |
  npx gemiflow agent spawn queen-coordinator \
...
spawn_command: |
  npx gemiflow agent spawn security-architect \
...
spawn_command: |
  npx gemiflow agent spawn security-implementer \
...
spawn_command: |
  npx gemiflow agent spawn security-tester \
...
spawn_command: |
  npx gemiflow agent spawn core-architect \
...
spawn_command: |
  npx gemiflow agent spawn core-implementer \
...
spawn_command: |
  npx gemiflow agent spawn memory-specialist \
...
spawn_command: |
  npx gemiflow agent spawn swarm-specialist \
...
spawn_command: |
  npx gemiflow agent spawn mcp-specialist \
    --focus "mcp,transport" \
...
spawn_command: |
  npx gemiflow agent spawn integration-architect \
...
spawn_command: |
  npx gemiflow agent spawn cli-hooks-developer \
    --focus "cli,hooks" \
    --interactive enabled
```
...
spawn_command: |
  npx gemiflow agent spawn neural-learning-developer \
...
spawn_command: |
  npx gemiflow agent spawn tdd-test-engineer \
    --focus "testing,tdd" \
...
spawn_command: |
  npx gemiflow agent spawn performance-engineer \
...
spawn_command: |
  npx gemiflow agent spawn release-engineer \
...
npx gemiflow swarm init v3-implementation \
  --topology hierarchical \
  --max-agents 15 \
  --github-sync enabled

# Spawn Queen Coordinator first
npx gemiflow agent spawn queen-coordinator --id 1

# Spawn Security Domain (parallel)
npx gemiflow agent spawn security-architect --id 2 &
npx gemiflow agent spawn security-implementer --id 3 &
npx gemiflow agent spawn security-tester --id 4 &

# Spawn Core Domain (parallel)
npx gemiflow agent spawn core-architect --id 5 &
npx gemiflow agent spawn core-implementer --id 6 &

wait

# Phase 2: Specialist agents
npx gemiflow agent spawn memory-specialist --id 7 &
npx gemiflow agent spawn swarm-specialist --id 8 &
npx gemiflow agent spawn mcp-specialist --id 9 &

wait

# Phase 3: Integration agents
npx gemiflow agent spawn integration-architect --id 10 &
npx gemiflow agent spawn cli-hooks-developer --id 11 &
npx gemiflow agent spawn neural-learning-developer --id 12 &

wait

# Phase 4: Quality & Deployment
npx gemiflow agent spawn tdd-test-engineer --id 13 &
npx gemiflow agent spawn performance-engineer --id 14 &
npx gemiflow agent spawn release-engineer --id 15 &

wait

echo "All 15 agents spawned successfully"
npx gemiflow swarm status
```
