...
**Example:**
```typescript
import { detectPlatform } from '@gemiflow/cli/init';
...
```typescript
import { generateSettings, generateSettingsJson } from '@gemiflow/cli/init';
...
```typescript
import { generateMCPConfig, generateMCPJson, generateMCPCommands } from '@gemiflow/cli/init';
...
// ['claude mcp add gemiflow -- npx @gemiflow/cli mcp start', ...]
```
...
```typescript
import { generateStatuslineScript, generateStatuslineHook } from '@gemiflow/cli/init';
...
const result = await executeInit({
  ...
  sourceBaseDir: '/path/to/gemiflow', // Source for skills/commands/agents
  force: true,
  components: {
...
```typescript
import { executeInit, detectPlatform, DEFAULT_INIT_OPTIONS } from '@gemiflow/cli/init';
...
```typescript
import { executeInit, MINIMAL_INIT_OPTIONS } from '@gemiflow/cli/init';
