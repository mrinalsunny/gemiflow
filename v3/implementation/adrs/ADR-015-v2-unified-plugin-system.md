...
- [x] Persist to `.gemiflow/plugins/installed.json`
...
CLI Commands (plugins.ts)
    ...
    └── PluginManager (manager.ts)
            │
            ├── InstalledPlugins manifest (.gemiflow/plugins/installed.json)
...
- [Plugin Interface](../../@gemiflow/plugins/src/core/plugin-interface.ts)
- [Plugin Registry](../../@gemiflow/plugins/src/registry/plugin-registry.ts)
- [Plugin Manager (CLI)](../../@gemiflow/cli/src/plugins/manager.ts)
- [Collection Manager](../../@gemiflow/plugins/src/collections/collection-manager.ts)
- [Dependency Graph](../../@gemiflow/plugins/src/registry/dependency-graph.ts)
- [Official Collections](../../@gemiflow/plugins/src/collections/official/index.ts)
