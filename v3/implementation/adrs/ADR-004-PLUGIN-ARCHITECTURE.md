...
**Official Plugins:**
1. `@gemiflow/hive-mind` - Queen-led coordination
2. `@gemiflow/neural` - Neural training system
3. `@gemiflow/verification` - Truth scoring
4. `@gemiflow/enterprise` - Advanced features
