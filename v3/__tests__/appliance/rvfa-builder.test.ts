...
import {
  ...
  encryptApiKeys,
  decryptApiKeys,
} from '../../@gemiflow/cli/src/appliance/rvfa-builder.js';
import { RvfaReader } from '../../@gemiflow/cli/src/appliance/rvfa-format.js';

// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------

const EXPECTED_SECTION_IDS = ['kernel', 'runtime', 'gemiflow', 'models', 'data', 'verify'];
