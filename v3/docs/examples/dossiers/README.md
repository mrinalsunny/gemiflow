...
Example outputs from the `gemiflow-goals` plugin's `dossier-collect` skill (ADR-099). Each subdirectory contains:
...
|---|---|---|---|
| [mrinalsunny/](./mrinalsunny/) | `mrinalsunny` (rUv) | username | gh API, WebSearch, profile fetch |
| [adr-088/](./adr-088/) | `ADR-088` | adr-id | Read, Grep, git log, codebase |
| [gemiflow-goals/](./gemiflow-goals/) | `gemiflow-goals` | concept (plugin) | Glob, Read, Grep |

## How to generate your own

```
/gemiflow-goals:dossier-collect <seed> [--max-depth N] [--max-breadth N] [--budget-usd N]
```
