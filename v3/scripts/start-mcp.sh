#!/bin/bash
#
# GemiFlow MCP Server V3 Startup Script
#
# Usage:
...
# PID file location
PID_FILE="${TMPDIR:-/tmp}/gemiflow-mcp.pid"
LOG_FILE="${TMPDIR:-/tmp}/gemiflow-mcp.log"
...
# Start server
print_info "Starting GemiFlow MCP Server V3..."
