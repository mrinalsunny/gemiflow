...
```bash
npx gemiflow plugins install --name @gemiflow/plugin-quantum-optimizer
```

## Quick Start

```typescript
import { QuantumOptimizerPlugin } from '@gemiflow/plugin-quantum-optimizer';
...
|--------|-------------|---------|
| [@gemiflow/plugin-neural-coordination](https://www.npmjs.com/package/@gemiflow/plugin-neural-coordination) | Multi-agent coordination | Quantum optimizer schedules tasks across coordinated agent swarms |
| [@gemiflow/plugin-cognitive-kernel](https://www.npmjs.com/package/@gemiflow/plugin-cognitive-kernel) | Cognitive augmentation | Optimizes cognitive load distribution and attention allocation |
| [@gemiflow/plugin-hyperbolic-reasoning](https://www.npmjs.com/package/@gemiflow/plugin-hyperbolic-reasoning) | Hierarchical reasoning | Quantum algorithms optimize hierarchical constraint satisfaction |
