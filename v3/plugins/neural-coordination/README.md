...
```bash
npx gemiflow plugins install --name @gemiflow/plugin-neural-coordination
```

## Quick Start

```typescript
import { NeuralCoordinationPlugin } from '@gemiflow/plugin-neural-coordination';
...
|--------|-------------|---------|
| [@gemiflow/plugin-cognitive-kernel](https://www.npmjs.com/package/@gemiflow/plugin-cognitive-kernel) | Cognitive augmentation with working memory | Enhances individual agent reasoning within coordinated swarms |
| [@gemiflow/plugin-quantum-optimizer](https://www.npmjs.com/package/@gemiflow/plugin-quantum-optimizer) | Quantum-inspired optimization | Optimizes task allocation and resource scheduling across agents |
| [@gemiflow/plugin-hyperbolic-reasoning](https://www.npmjs.com/package/@gemiflow/plugin-hyperbolic-reasoning) | Hierarchical reasoning | Enables hierarchical agent organization and taxonomic coordination |
