...
- `@gemiflow/plugin-agentic-qe@3.0.0-alpha.2` (28 files, ~17,036 LOC)
- `@gemiflow/plugin-prime-radiant@0.1.4` (21 files, ~9,136 LOC)
...
sandbox:
  ...
  filesystem:
    ...
    blockedPaths:
      ...
      - ~/.aws
      - ~/.config
      - node_modules/@gemiflow/security  # Prevent reading security module
```
...
```typescript
// MUST use SafeExecutor from @gemiflow/security
import { SafeExecutor } from '@gemiflow/security';
...
import { z } from 'zod';
import { PathSchema, IdentifierSchema, SafeStringSchema } from '@gemiflow/security';
...
```typescript
import { aidefence } from '@gemiflow/aidefence';
...
{
  "dependencies": {
    "@gemiflow/security": ">=3.0.0",  # REQUIRED
...
- [ ] PathValidator imported from `@gemiflow/security`
- [ ] SafeExecutor imported from `@gemiflow/security`
- [ ] InputValidator imported from `@gemiflow/security`
...
// src/schemas.ts
import { z } from 'zod';
import { IdentifierSchema } from '@gemiflow/security';
...
**Published Versions:**
- `@gemiflow/plugin-agentic-qe@3.0.0-alpha.2`
- `@gemiflow/plugin-prime-radiant@0.1.4`
