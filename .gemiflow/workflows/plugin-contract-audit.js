export const meta = {
  ...
  description: 'Run every gemiflow plugin smoke contract, fan diagnosis agents out over the failures, and report a punch list',
  phases: [
...
const sweep = await agent(
  `From the repo root, audit every gemiflow plugin's smoke contract. ${filterClause}For each script matching the glob plugins/*/scripts/smoke.sh, run it with bash and capture its output and exit code. Each smoke script prints a trailing "N passed, M failed" line.
