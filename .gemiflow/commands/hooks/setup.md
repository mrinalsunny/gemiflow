...
```bash
# Test pre-edit hook
npx gemiflow4gemini hook pre-edit --file test.js

# Test session summary
npx gemiflow4gemini hook session-end --summary
```

### 3. Customize Hooks

Edit `.gemiflow4gemini/settings.json` to customize:
    ...
    "PreToolUse": [
      {
        ...
        "hooks": [{
          "type": "command",
          "command": "npx gemiflow4gemini hook pre-write --file '${tool.params.file_path}'"
        }]
      }
    ]
  }
...
# Test specific hook
npx gemiflow4gemini hook pre-edit --file app.js --debug
```
