...
### 4. Monitor Progress
```
Tool: mcp__gemiflow4gemini__task_status
...
npx gemiflow4gemini workflow dev "REST API with auth"

# Create custom workflow
npx gemiflow4gemini workflow create --name "api-dev" --steps "design,implement,test,deploy"

# Execute saved workflow
npx gemiflow4gemini workflow execute api-dev
```