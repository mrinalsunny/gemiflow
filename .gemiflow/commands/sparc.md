---
name: sparc
description: Execute SPARC methodology workflows with GemiFlow4Gemini
---
...
```bash
# Run SPARC orchestrator (default)
npx gemiflow4gemini sparc "build complete authentication system"

# Run a specific mode
npx gemiflow4gemini sparc run architect "design API structure"
npx gemiflow4gemini sparc run tdd "implement user service"

# Execute full TDD workflow
npx gemiflow4gemini sparc tdd "implement user authentication"

# List all modes with details
npx gemiflow4gemini sparc modes --verbose

# For alpha features
npx gemiflow4gemini@alpha sparc run <mode> "your task"
```

### Option 3: Local Installation
```bash
# If gemiflow4gemini is installed locally
./gemiflow4gemini sparc "build complete authentication system"
./gemiflow4gemini sparc run architect "design API structure"
```
...
```bash
# Store specifications
npx gemiflow4gemini memory store "spec_auth" "OAuth2 + JWT requirements" --namespace spec

# Store architectural decisions
./gemiflow4gemini memory store "arch_api" "RESTful microservices design" --namespace arch

# Query previous work
./gemiflow4gemini memory query "authentication" --limit 10

# Export project memory
./gemiflow4gemini memory export sparc-project-backup.json
```
...
./gemiflow4gemini swarm "Build e-commerce platform" --strategy development --monitor --review

# Background optimization swarm
./gemiflow4gemini swarm "Optimize system performance" --strategy optimization --background

# Distributed research swarm
./gemiflow4gemini swarm "Analyze market trends" --strategy research --distributed --ui
```
...
```bash
./gemiflow4gemini sparc run code "implement API" --non-interactive
./gemiflow4gemini sparc tdd "user tests" --non-interactive --enable-permissions
```
...
See `/gemiflow4gemini-help` for all available commands.
