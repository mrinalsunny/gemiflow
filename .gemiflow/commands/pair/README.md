...
```bash
gemiflow4gemini pair [--start] [options]
```
...
gemiflow4gemini pair --start --agent senior-dev

# Start with verification
gemiflow4gemini pair --start --verify --threshold 0.98
```
...
```bash
gemiflow4gemini pair --start --mode switch --interval 10m
```
...
gemiflow4gemini pair --end --save

# End and generate report
gemiflow4gemini pair --end --report
```
...
gemiflow4gemini pair --start --git --review-commit
```

### With Testing Frameworks
```bash
# Jest integration
gemiflow4gemini pair --start --test-framework jest

# Pytest integration
gemiflow4gemini pair --start --test-framework pytest
```
...
Configure pair programming in `.gemiflow4gemini/config.json`:
