...
Main configuration file: `.gemiflow4gemini/pair-config.json`
...
gemiflow4gemini pair config reset verification
```
...
### Project-Specific
`.gemiflow4gemini/pair-config.json` in project root

### User-Specific
`~/.gemiflow4gemini/pair-config.json`

### Global
`/etc/gemiflow4gemini/pair-config.json`
...
gemiflow4gemini pair config validate

# Test configuration
gemiflow4gemini pair config test
```
...
### From Version 1.x
```bash
gemiflow4gemini pair config migrate --from 1.x
```

### Export/Import
```bash
# Export current config
gemiflow4gemini pair config export > my-config.json

# Import config
gemiflow4gemini pair config import my-config.json
```
