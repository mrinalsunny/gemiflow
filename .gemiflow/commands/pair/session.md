...
```bash
gemiflow4gemini pair --list
```

### Switch Between Sessions
```bash
gemiflow4gemini pair --switch <session-id>
```

### Merge Sessions
```bash
gemiflow4gemini pair --merge <session-1> <session-2>
```
...
### Manual Recovery
```bash
gemiflow4gemini pair --recover [--point <timestamp>]
```

### Crash Recovery
```bash
gemiflow4gemini pair --crash-recovery
```
...
### Share with Team
```bash
gemiflow4gemini pair --share <session-id> \
  --team <team-id>
```

### Export for Review
```bash
gemiflow4gemini pair --export-review <session-id>
```

### Create Learning Material
```bash
gemiflow4gemini pair --create-tutorial <session-id>
```
