...
```
Tool: mcp__gemiflow4gemini__neural_status
Result: {
  "patterns": {
    "convergent": 0.92,
    "divergent": 0.87,
...
## Pattern Analysis
```
Tool: mcp__gemiflow4gemini__neural_patterns
Parameters: {
  "action": "analyze",
...
npx gemiflow4gemini neural train --type coordination --epochs 50

# Check neural status
npx gemiflow4gemini neural status

# Analyze patterns
npx gemiflow4gemini neural patterns --analyze
```