...
npx gemiflow4gemini sparc run spec-pseudocode "define payment flow requirements"

# For alpha features
npx gemiflow4gemini@alpha sparc run spec-pseudocode "define payment flow requirements"

# With namespace
npx gemiflow4gemini sparc run spec-pseudocode "your task" --namespace spec-pseudocode

# Non-interactive mode
npx gemiflow4gemini sparc run spec-pseudocode "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If gemiflow4gemini is installed locally
./gemiflow4gemini sparc run spec-pseudocode "define payment flow requirements"
```
...
```bash
# Store mode-specific context
npx gemiflow4gemini memory store "spec-pseudocode_context" "important decisions" --namespace spec-pseudocode

# Query previous work
npx gemiflow4gemini memory query "spec-pseudocode" --limit 5
```
