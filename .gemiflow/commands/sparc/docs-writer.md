...
npx gemiflow4gemini sparc run docs-writer "create API documentation"

# For alpha features
npx gemiflow4gemini@alpha sparc run docs-writer "create API documentation"

# With namespace
npx gemiflow4gemini sparc run docs-writer "your task" --namespace docs-writer

# Non-interactive mode
npx gemiflow4gemini sparc run docs-writer "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If gemiflow4gemini is installed locally
./gemiflow4gemini sparc run docs-writer "create API documentation"
```
...
```bash
# Store mode-specific context
npx gemiflow4gemini memory store "docs-writer_context" "important decisions" --namespace docs-writer

# Query previous work
npx gemiflow4gemini memory query "docs-writer" --limit 5
```
