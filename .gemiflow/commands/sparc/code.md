...
npx gemiflow4gemini sparc run code "implement REST API endpoints"

# For alpha features
npx gemiflow4gemini@alpha sparc run code "implement REST API endpoints"

# With namespace
npx gemiflow4gemini sparc run code "your task" --namespace code

# Non-interactive mode
npx gemiflow4gemini sparc run code "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If gemiflow4gemini is installed locally
./gemiflow4gemini sparc run code "implement REST API endpoints"
```
...
```bash
# Store mode-specific context
npx gemiflow4gemini memory store "code_context" "important decisions" --namespace code

# Query previous work
npx gemiflow4gemini memory query "code" --limit 5
```
