...
npx gemiflow4gemini sparc run memory-manager "organize project knowledge"

# For alpha features
npx gemiflow4gemini@alpha sparc run memory-manager "organize project knowledge"
```

### Option 3: Local Installation
```bash
# If gemiflow4gemini is installed locally
./gemiflow4gemini sparc run memory-manager "organize project knowledge"
```
