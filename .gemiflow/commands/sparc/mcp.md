...
npx gemiflow4gemini sparc run mcp "integrate with external API"

# For alpha features
npx gemiflow4gemini@alpha sparc run mcp "integrate with external API"

# With namespace
npx gemiflow4gemini sparc run mcp "your task" --namespace mcp

# Non-interactive mode
npx gemiflow4gemini sparc run mcp "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If gemiflow4gemini is installed locally
./gemiflow4gemini sparc run mcp "integrate with external API"
```
...
```bash
# Store mode-specific context
npx gemiflow4gemini memory store "mcp_context" "important decisions" --namespace mcp

# Query previous work
npx gemiflow4gemini memory query "mcp" --limit 5
```
