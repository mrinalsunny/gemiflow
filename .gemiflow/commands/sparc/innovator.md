...
npx gemiflow4gemini sparc run innovator "innovative solutions for scaling"

# For alpha features
npx gemiflow4gemini@alpha sparc run innovator "innovative solutions for scaling"
```

### Option 3: Local Installation
```bash
# If gemiflow4gemini is installed locally
./gemiflow4gemini sparc run innovator "innovative solutions for scaling"
```
