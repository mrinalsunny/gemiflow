...
npx gemiflow4gemini sparc run reviewer "review pull request #123"

# For alpha features
npx gemiflow4gemini@alpha sparc run reviewer "review pull request #123"
```

### Option 3: Local Installation
```bash
# If gemiflow4gemini is installed locally
./gemiflow4gemini sparc run reviewer "review pull request #123"
```
