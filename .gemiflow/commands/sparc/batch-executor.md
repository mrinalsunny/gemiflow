...
npx gemiflow4gemini sparc run batch-executor "process multiple files"

# For alpha features
npx gemiflow4gemini@alpha sparc run batch-executor "process multiple files"
```

### Option 3: Local Installation
```bash
# If gemiflow4gemini is installed locally
./gemiflow4gemini sparc run batch-executor "process multiple files"
```
