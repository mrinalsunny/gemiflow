...
npx gemiflow4gemini sparc run tdd "shopping cart feature"

# For alpha features
npx gemiflow4gemini@alpha sparc run tdd "shopping cart feature"
```

### Option 3: Local Installation
```bash
# If gemiflow4gemini is installed locally
./gemiflow4gemini sparc run tdd "shopping cart feature"
```
