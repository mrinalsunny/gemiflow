...
npx gemiflow4gemini sparc run integration "connect payment service"

# For alpha features
npx gemiflow4gemini@alpha sparc run integration "connect payment service"

# With namespace
npx gemiflow4gemini sparc run integration "your task" --namespace integration

# Non-interactive mode
npx gemiflow4gemini sparc run integration "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If gemiflow4gemini is installed locally
./gemiflow4gemini sparc run integration "connect payment service"
```
...
```bash
# Store mode-specific context
npx gemiflow4gemini memory store "integration_context" "important decisions" --namespace integration

# Query previous work
npx gemiflow4gemini memory query "integration" --limit 5
```
