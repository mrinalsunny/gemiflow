...
npx gemiflow4gemini sparc run refinement-optimization-mode "optimize database queries"

# For alpha features
npx gemiflow4gemini@alpha sparc run refinement-optimization-mode "optimize database queries"

# With namespace
npx gemiflow4gemini sparc run refinement-optimization-mode "your task" --namespace refinement-optimization-mode

# Non-interactive mode
npx gemiflow4gemini sparc run refinement-optimization-mode "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If gemiflow4gemini is installed locally
./gemiflow4gemini sparc run refinement-optimization-mode "optimize database queries"
```
...
```bash
# Store mode-specific context
npx gemiflow4gemini memory store "refinement-optimization-mode_context" "important decisions" --namespace refinement-optimization-mode

# Query previous work
npx gemiflow4gemini memory query "refinement-optimization-mode" --limit 5
```
