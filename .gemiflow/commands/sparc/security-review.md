...
npx gemiflow4gemini sparc run security-review "audit API security"

# For alpha features
npx gemiflow4gemini@alpha sparc run security-review "audit API security"

# With namespace
npx gemiflow4gemini sparc run security-review "your task" --namespace security-review

# Non-interactive mode
npx gemiflow4gemini sparc run security-review "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If gemiflow4gemini is installed locally
./gemiflow4gemini sparc run security-review "audit API security"
```
...
```bash
# Store mode-specific context
npx gemiflow4gemini memory store "security-review_context" "important decisions" --namespace security-review

# Query previous work
npx gemiflow4gemini memory query "security-review" --limit 5
```
