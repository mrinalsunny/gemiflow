...
npx gemiflow4gemini sparc run analyzer "analyze codebase performance"

# For alpha features
npx gemiflow4gemini@alpha sparc run analyzer "analyze codebase performance"
```

### Option 3: Local Installation
```bash
# If gemiflow4gemini is installed locally
./gemiflow4gemini sparc run analyzer "analyze codebase performance"
```
