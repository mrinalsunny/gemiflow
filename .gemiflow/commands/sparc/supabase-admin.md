...
npx gemiflow4gemini sparc run supabase-admin "create user authentication schema"

# For alpha features
npx gemiflow4gemini@alpha sparc run supabase-admin "create user authentication schema"

# With namespace
npx gemiflow4gemini sparc run supabase-admin "your task" --namespace supabase-admin

# Non-interactive mode
npx gemiflow4gemini sparc run supabase-admin "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If gemiflow4gemini is installed locally
./gemiflow4gemini sparc run supabase-admin "create user authentication schema"
```
...
```bash
# Store mode-specific context
npx gemiflow4gemini memory store "supabase-admin_context" "important decisions" --namespace supabase-admin

# Query previous work
npx gemiflow4gemini memory query "supabase-admin" --limit 5
```
