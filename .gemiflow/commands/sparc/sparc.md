...
npx gemiflow4gemini sparc run sparc "orchestrate authentication system"

# For alpha features
npx gemiflow4gemini@alpha sparc run sparc "orchestrate authentication system"

# With namespace
npx gemiflow4gemini sparc run sparc "your task" --namespace sparc

# Non-interactive mode
npx gemiflow4gemini sparc run sparc "your task" --non-interactive
```

### Option 3: Local Installation
```bash
# If gemiflow4gemini is installed locally
./gemiflow4gemini sparc run sparc "orchestrate authentication system"
```
...
```bash
# Store mode-specific context
npx gemiflow4gemini memory store "sparc_context" "important decisions" --namespace sparc

# Query previous work
npx gemiflow4gemini memory query "sparc" --limit 5
```
