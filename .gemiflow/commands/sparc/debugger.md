...
npx gemiflow4gemini sparc run debugger "fix authentication issues"

# For alpha features
npx gemiflow4gemini@alpha sparc run debugger "fix authentication issues"
```

### Option 3: Local Installation
```bash
# If gemiflow4gemini is installed locally
./gemiflow4gemini sparc run debugger "fix authentication issues"
```
