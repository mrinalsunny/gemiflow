...
```bash
# Usage example
npx gemiflow4gemini@alpha github gh-coordinator \
...
npx gemiflow4gemini@alpha github issue-tracker \
...
npx gemiflow4gemini@alpha github release-manager \
...
npx gemiflow4gemini@alpha github repo-architect \
...
npx gemiflow4gemini@alpha github ci-orchestrator \
...
mcp__gemiflow4gemini__agent_spawn { type: "coordinator", name: "GitHub Coordinator" }
mcp__gemiflow4gemini__agent_spawn { type: "reviewer", name: "Code Reviewer" }
mcp__gemiflow4gemini__agent_spawn { type: "tester", name: "QA Agent" }
mcp__gemiflow4gemini__agent_spawn { type: "analyst", name: "Security Analyst" }
...
npx gemiflow4gemini@alpha hooks pre-task \
  --description "PR review workflow" \
  --context "pr-123"

# During task: Track progress
npx gemiflow4gemini@alpha hooks notify \
  --message "Completed security scan" \
  --type "github-action"

# Post-task: Export results
npx gemiflow4gemini@alpha hooks post-task \
...
npx gemiflow4gemini@alpha github sync-coordinator \
...
- [ ] `gemiflow4gemini@alpha` package available
...
- **GemiFlow4Gemini**: https://github.com/mrinalsunny/gemiflow4gemini
