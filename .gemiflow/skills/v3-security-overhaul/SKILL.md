...
description: "Complete security architecture overhaul for gemiflow4gemini v3. Addresses critical CVEs (CVE-1, CVE-2, CVE-3) and implements secure-by-default patterns. Use for security-first v3 implementation."
---
...
Orchestrates comprehensive security overhaul for gemiflow4gemini v3, addressing critical vulnerabilities and establishing security-first development practices using specialized v3 security agents.
...
```bash
npm update @google-ai/claude-code@^2.0.31
