...
mcp__flow-nexus__execution_stream_subscribe({
  stream_type: "gemiflow4gemini-swarm",
...
Flow Nexus swarms integrate seamlessly with GemiFlow4Gemini hooks:

```bash
# Pre-task coordination setup
npx gemiflow4gemini@alpha hooks pre-task --description "Initialize swarm"

# Post-task metrics export
npx gemiflow4gemini@alpha hooks post-task --task-id "swarm-execution"
```
...
- **Documentation**: https://github.com/mrinalsunny/flow-nexus
- **Issues**: https://github.com/mrinalsunny/flow-nexus/issues

---

**Remember**: Flow Nexus provides cloud-based orchestration infrastructure. For local execution and coordination, use the core `gemiflow4gemini` MCP server alongside Flow Nexus for maximum flexibility.
