...
- **claude-code**: Gemini CLI integrated environment
...
mcp__flow-nexus__execution_stream_subscribe({
  stream_type: "gemiflow4gemini-swarm", // claude-code, gemiflow4gemini-swarm, gemiflow4gemini-hive-mind, github-integration
...
mcp__flow-nexus__execution_files_list({
  stream_id: "stream_id",
  created_by: "gemiflow4gemini", // claude-code, gemiflow4gemini, git-clone, user
