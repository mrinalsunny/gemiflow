...
SPARC (Specification, Pseudocode, Architecture, Refinement, Completion) is a systematic development methodology integrated with GemiFlow4Gemini's multi-agent orchestration capabilities. It provides 17 specialized modes for comprehensive software development, from initial research through deployment and monitoring.
...
npx gemiflow4gemini sparc tdd "feature description"

# Batch execution
npx gemiflow4gemini sparc batch <mode1,mode2,mode3> "task"

# Pipeline execution
npx gemiflow4gemini sparc pipeline "task description"
```

### Method 3: Local Installation

**Best for**: Projects with local gemiflow4gemini installation
...
mcp__gemiflow4gemini__agent_spawn { type: "architect" }
mcp__gemiflow4gemini__agent_spawn { type: "coder" }
mcp__gemiflow4gemini__agent_spawn { type: "tester" }
mcp__gemiflow4gemini__agent_spawn { type: "reviewer" }
```
...
[Single Message]:
  mcp__gemiflow4gemini__agent_spawn { type: "researcher" }
  mcp__gemiflow4gemini__agent_spawn { type: "coder" }
  mcp__gemiflow4gemini__agent_spawn { type: "tester" }
  TodoWrite { todos: [8-10 todos] }

// ❌ WRONG: Multiple messages
Message 1: mcp__gemiflow4gemini__agent_spawn { type: "researcher" }
Message 2: mcp__gemiflow4gemini__agent_spawn { type: "coder" }
...
```bash
# Before work
npx gemiflow4gemini@alpha hooks pre-task --description "implement auth"

# During work
npx gemiflow4gemini@alpha hooks post-edit --file "auth.js"

# After work
npx gemiflow4gemini@alpha hooks post-task --task-id "task-123"
```
...
npx gemiflow4gemini sparc run researcher "authentication patterns"

# Step 2: Architecture design
npx gemiflow4gemini sparc run architect "design auth system"

# Step 3: TDD implementation
npx gemiflow4gemini sparc tdd "user authentication feature"

# Step 4: Code review
npx gemiflow4gemini sparc run reviewer "review auth implementation"

# Step 5: Documentation
npx gemiflow4gemini sparc run documenter "document auth API"
```
...
npx gemiflow4gemini sparc run analyzer "investigate bug #456"

# Step 2: Debug systematically
npx gemiflow4gemini sparc run debugger "fix memory leak in service X"

# Step 3: Create tests
npx gemiflow4gemini sparc run tester "regression tests for bug #456"

# Step 4: Review fix
npx gemiflow4gemini sparc run reviewer "validate bug fix"
```
...
npx gemiflow4gemini sparc run analyzer "profile API response times"

# Step 2: Identify bottlenecks
npx gemiflow4gemini sparc run optimizer "optimize database queries"

# Step 3: Implement improvements
npx gemiflow4gemini sparc run coder "implement caching layer"

# Step 4: Benchmark results
npx gemiflow4gemini sparc run tester "performance benchmarks"
```
...
npx gemiflow4gemini sparc pipeline "e-commerce checkout feature"
...
```javascript
// Analyze repository
mcp__gemiflow4gemini__github_repo_analyze {
  repo: "owner/repo",
  analysis_type: "code_quality"
}

// Manage pull requests
mcp__gemiflow4gemini__github_pr_manage {
  repo: "owner/repo",
  pr_number: 123,
  action: "review"
}
...
mcp__gemiflow4gemini__token_usage {
...
# Run specific mode
npx gemiflow4gemini sparc run <mode> "task"

# TDD workflow
npx gemiflow4gemini sparc tdd "feature"

# Full pipeline
npx gemiflow4gemini sparc pipeline "task"

# Batch execution
npx gemiflow4gemini sparc batch <modes> "task"
```
...
```javascript
// Initialize swarm
mcp__gemiflow4gemini__swarm_init { topology: "hierarchical" }

// Execute mode
mcp__gemiflow4gemini__sparc_mode { mode: "coder", task_description: "..." }

// Monitor progress
mcp__gemiflow4gemini__swarm_monitor { interval: 5000 }

// Store in memory
mcp__gemiflow4gemini__memory_usage { action: "store", key: "...", value: "..." }
```
