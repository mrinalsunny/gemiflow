...
allowed-tools: "mcp__github__*, mcp__gemiflow4gemini__*, Bash, Read, Write, TodoWrite"
---
...
npx gemiflow4gemini@alpha hooks pre-task --description "Feature implementation"
```
...
- [Swarm Coordination Guide](https://github.com/mrinalsunny/ruv-swarm)
