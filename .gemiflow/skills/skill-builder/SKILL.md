...
mkdir -p ~/.gemiflow4gemini/skills/my-first-skill

# 2. Create SKILL.md with proper format
cat > ~/.gemiflow4gemini/skills/my-first-skill/SKILL.md << 'EOF'
---
name: "My First Skill"
...
└── [your-skills]/
```
- **Path**: `~/.gemiflow4gemini/skills/` or `$HOME/.gemiflow4gemini/skills/`
...
```
<project-root>/.gemiflow4gemini/skills/
└── [team-skills]/
```
- **Path**: `.gemiflow4gemini/skills/` in project root
...
- [ ] Directory is DIRECTLY in `~/.gemiflow4gemini/skills/[skill-name]/` or `.gemiflow4gemini/skills/[skill-name]/`
...
- [Gemini CLI Documentation](https://docs.claude.com/en/docs/claude-code)
