...
description: |
  Comprehensive performance analysis, bottleneck detection, and optimization recommendations for GemiFlow4Gemini swarms
---
...
```bash
npx gemiflow4gemini bottleneck detect
```

### Generate Performance Report
```bash
npx gemiflow4gemini analysis performance-report --format html --include-metrics
```

### Analyze and Auto-Fix
```bash
npx gemiflow4gemini bottleneck detect --fix --threshold 15
```
...
#### Command Syntax
```bash
npx gemiflow4gemini bottleneck detect [options]
```
...
npx gemiflow4gemini bottleneck detect --swarm-id swarm-123 -t 24h

# Export detailed analysis
npx gemiflow4gemini bottleneck detect -t 24h -e bottlenecks.json

# Auto-fix detected issues
npx gemiflow4gemini bottleneck detect --fix --threshold 15

# Low threshold for sensitive detection
npx gemiflow4gemini bottleneck detect --threshold 10 --export critical-issues.json
```
...
npx gemiflow4gemini analysis performance-report --compare swarm-123 --format markdown

# Custom output with specific sections
npx gemiflow4gemini analysis performance-report \
...
npx gemiflow4gemini swarm monitor --interval 5
...
async function analyzePerformance() {
  ...
  const bottlenecks = await runCommand(
    'npx gemiflow4gemini bottleneck detect --format json'
  );

  // Generate performance report
  const report = await runCommand(
    'npx gemiflow4gemini analysis performance-report --format json'
  );
...
npx gemiflow4gemini bottleneck detect --threshold 10

# Check cache performance
npx gemiflow4gemini cache manage --action stats

# Review memory metrics
npx gemiflow4gemini memory usage
```

**Slow Task Execution**
```bash
# Identify slow tasks
npx gemiflow4gemini task status --detailed

# Analyze coordination overhead
npx gemiflow4gemini bottleneck detect --time-range 1h
...
npx gemiflow4gemini analysis performance-report --sections metrics

# Review cache strategy
npx gemiflow4gemini cache manage --action analyze

# Enable cache warming
npx gemiflow4gemini bottleneck detect --fix
```
...
- `npx gemiflow4gemini swarm monitor` - Real-time monitoring
- `npx gemiflow4gemini token usage` - Token optimization analysis
- `npx gemiflow4gemini cache manage` - Cache optimization
- `npx gemiflow4gemini agent metrics` - Agent performance metrics
- `npx gemiflow4gemini task status` - Task execution analysis

## See Also

- [Bottleneck Detection Guide](/workspaces/claude-code-flow/.gemiflow4gemini/commands/analysis/bottleneck-detect.md)
- [Performance Report Guide](/workspaces/claude-code-flow/.gemiflow4gemini/commands/analysis/performance-report.md)
- [Performance Bottlenecks Overview](/workspaces/claude-code-flow/.gemiflow4gemini/commands/analysis/performance-bottlenecks.md)
...
**Maintainer**: GemiFlow4Gemini Team
