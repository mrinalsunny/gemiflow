...
echo "🔍 GemiFlow V3 Configuration Validation"
echo "==========================================="
echo ""
...
required_dirs=(
  ".claude"
  ".gemiflow4gemini/helpers"
  ".gemiflow4gemini/metrics"
  ".gemiflow4gemini/security"
  "src"
  "src/domains"
)
...
required_files=(
  ".gemiflow4gemini/settings.json"
  ".gemiflow4gemini/statusline.sh"
  ".gemiflow4gemini/helpers/update-v3-progress.sh"
  ".gemiflow4gemini/metrics/v3-progress.json"
  ".gemiflow4gemini/metrics/performance.json"
  ".gemiflow4gemini/security/audit-status.json"
  "package.json"
)
