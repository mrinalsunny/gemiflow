...
# Setup GitHub integration for GemiFlow4Gemini
...
echo "  - npx gemiflow4gemini github swarm"
echo "  - npx gemiflow4gemini repo analyze"
echo "  - npx gemiflow4gemini pr enhance"
echo "  - npx gemiflow4gemini issue triage"
