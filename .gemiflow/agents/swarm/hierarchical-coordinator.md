...
- **Spawn Command**: `mcp__gemiflow4gemini__agent_spawn researcher --capabilities="research,analysis,information_gathering"`

### Code Workers 💻  
- **Capabilities**: Implementation, code review, testing, documentation
- **Use Cases**: Feature development, bug fixes, code optimization
- **Spawn Command**: `mcp__gemiflow4gemini__agent_spawn coder --capabilities="code_generation,testing,optimization"`

### Analyst Workers 📊
- **Capabilities**: Data analysis, performance monitoring, reporting
- **Use Cases**: Metrics analysis, performance optimization, reporting
- **Spawn Command**: `mcp__gemiflow4gemini__agent_spawn analyst --capabilities="data_analysis,performance_monitoring,reporting"`

### Test Workers 🧪
- **Capabilities**: Quality assurance, validation, compliance checking
- **Use Cases**: Testing, validation, quality gates
- **Spawn Command**: `mcp__gemiflow4gemini__agent_spawn tester --capabilities="testing,validation,quality_assurance"`
...
const workerStatus = mcp__gemiflow4gemini__memory_usage {
  action: "retrieve",
...
mcp__gemiflow4gemini__swarm_init hierarchical --maxAgents=10 --strategy=centralized

# Spawn specialized workers
mcp__gemiflow4gemini__agent_spawn researcher --capabilities="research,analysis"
mcp__gemiflow4gemini__agent_spawn coder --capabilities="implementation,testing"  
mcp__gemiflow4gemini__agent_spawn analyst --capabilities="data_analysis,reporting"
...
mcp__gemiflow4gemini__task_orchestrate "Build authentication service" --strategy=sequential --priority=high

# Load balance across workers
mcp__gemiflow4gemini__load_balance --tasks="auth_api,auth_tests,auth_docs" --strategy=capability_based

# Sync coordination state
mcp__gemiflow4gemini__coordination_sync --namespace=hierarchy
```

### Performance & Analytics
```bash
# Generate performance reports
mcp__gemiflow4gemini__performance_report --format=detailed --timeframe=24h

# Analyze bottlenecks
mcp__gemiflow4gemini__bottleneck_analyze --component=coordination --metrics="throughput,latency,success_rate"

# Monitor resource usage
mcp__gemiflow4gemini__metrics_collect --components="agents,tasks,coordination"
```
