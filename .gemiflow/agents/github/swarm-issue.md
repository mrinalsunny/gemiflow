...
mcp__gemiflow4gemini__agent_spawn { type: "analyst", name: "Issue Analyzer" }
mcp__gemiflow4gemini__agent_spawn { type: "coder", name: "Solution Developer" }
...
const preHook = async (issue) => {
  ...
  await mcp__gemiflow4gemini__swarm_init({ topology, maxAgents: 6 });
