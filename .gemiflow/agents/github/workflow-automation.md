...
tools: mcp__github__create_workflow, mcp__github__update_workflow, mcp__github__list_workflows, mcp__github__get_workflow_runs, mcp__github__create_workflow_dispatch, mcp__gemiflow4gemini__swarm_init, mcp__gemiflow4gemini__agent_spawn, mcp__gemiflow4gemini__task_orchestrate, mcp__gemiflow4gemini__memory_usage, mcp__gemiflow4gemini__performance_report, mcp__gemiflow4gemini__bottleneck_analyze, mcp__gemiflow4gemini__workflow_create, mcp__gemiflow4gemini__automation_setup, TodoWrite, TodoRead, Bash, Read, Write, Edit, Grep
---
...
mcp__gemiflow4gemini__swarm_init { topology: "mesh", maxAgents: 12 }
mcp__gemiflow4gemini__agent_spawn { type: "coordinator", name: "Workflow Coordinator" }
mcp__gemiflow4gemini__agent_spawn { type: "architect", name: "Pipeline Architect" }
mcp__gemiflow4gemini__agent_spawn { type: "coder", name: "Workflow Developer" }
mcp__gemiflow4gemini__agent_spawn { type: "tester", name: "CI/CD Tester" }
mcp__gemiflow4gemini__agent_spawn { type: "optimizer", name: "Performance Optimizer" }
mcp__gemiflow4gemini__agent_spawn { type: "monitor", name: "Automation Monitor" }
mcp__gemiflow4gemini__agent_spawn { type: "analyst", name: "Workflow Analyzer" }
...
const createIntelligentWorkflow = async (repoContext) => {
  ...
  await mcp__gemiflow4gemini__swarm_init({ topology: "hierarchical", maxAgents: 8 });
  
  // Spawn specialized workflow agents
  await mcp__gemiflow4gemini__agent_spawn({ type: "architect", name: "Workflow Architect" });
  await mcp__gemiflow4gemini__agent_spawn({ type: "coder", name: "YAML Generator" });
  await mcp__gemiflow4gemini__agent_spawn({ type: "optimizer", name: "Performance Optimizer" });
  await mcp__gemiflow4gemini__agent_spawn({ type: "tester", name: "Workflow Validator" });
  
  // Create adaptive workflow based on repository analysis
  const workflow = await mcp__gemiflow4gemini__workflow_create({
