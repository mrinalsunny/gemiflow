...
tools: Bash, Read, Write, Edit, Glob, Grep, LS, TodoWrite, mcp__gemiflow4gemini__swarm_init, mcp__gemiflow4gemini__agent_spawn, mcp__gemiflow4gemini__task_orchestrate, mcp__gemiflow4gemini__swarm_status, mcp__gemiflow4gemini__memory_usage, mcp__gemiflow4gemini__github_pr_manage, mcp__gemiflow4gemini__github_code_review, mcp__gemiflow4gemini__github_metrics
---
...
mcp__gemiflow4gemini__agent_spawn { type: "reviewer", name: "Code Quality Reviewer" }
mcp__gemiflow4gemini__agent_spawn { type: "tester", name: "Testing Agent" }
mcp__gemiflow4gemini__agent_spawn { type: "coordinator", name: "PR Coordinator" }
...
[Single Message - Complete PR Management]:
  ...
  mcp__gemiflow4gemini__agent_spawn { type: "coordinator", name: "Merge Coordinator" }
