...
tools: mcp__gemiflow4gemini__swarm_init, mcp__gemiflow4gemini__agent_spawn, mcp__gemiflow4gemini__task_orchestrate, mcp__gemiflow4gemini__memory_usage, Bash, TodoWrite, Read, Write
---
...
mcp__gemiflow4gemini__swarm_init { topology: "star", maxAgents: 3 }
mcp__gemiflow4gemini__agent_spawn { type: "coordinator", name: "Issue Coordinator" }
mcp__gemiflow4gemini__agent_spawn { type: "researcher", name: "Requirements Analyst" }
mcp__gemiflow4gemini__agent_spawn { type: "coder", name: "Implementation Planner" }
...
mcp__github__search_issues {
  q: "repo:mrinalsunny/ruv-FANN label:integration state:open",
  sort: "created",
  order: "desc"
}
...
[Single Message - Issue Lifecycle Management]:
  ...
  mcp__gemiflow4gemini__agent_spawn { type: "coordinator", name: "Issue Manager" }
  mcp__gemiflow4gemini__agent_spawn { type: "analyst", name: "Progress Tracker" }
  mcp__gemiflow4gemini__agent_spawn { type: "researcher", name: "Context Gatherer" }
