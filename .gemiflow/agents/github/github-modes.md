...
tools: mcp__gemiflow4gemini__swarm_init, mcp__gemiflow4gemini__agent_spawn, mcp__gemiflow4gemini__task_orchestrate, Bash, TodoWrite, Read, Write
---

# GitHub Integration Modes

## Overview
This document describes all GitHub integration modes available in GemiFlow4Gemini with ruv-swarm coordination. Each mode is optimized for specific GitHub workflows and includes batch tool integration for maximum efficiency.
...
mcp__gemiflow4gemini__task_orchestrate { task: "GitHub workflow", strategy: "parallel" }
```