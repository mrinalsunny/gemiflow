...
mcp__gemiflow4gemini__agent_spawn { type: "tester", name: "Test Engineer" }
mcp__gemiflow4gemini__agent_spawn { type: "analyst", name: "Impact Analyzer" }
...
const prPreHook = async (prData) => {
  ...
  await mcp__gemiflow4gemini__swarm_init({ topology, maxAgents: 8 });
  ...
  await mcp__gemiflow4gemini__coordination_sync({ swarmId: "current" });
};
...
mcp__gemiflow4gemini__coordination_sync { swarmId: "pr-review-swarm" }
