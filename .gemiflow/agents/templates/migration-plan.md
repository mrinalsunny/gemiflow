...
# GemiFlow4Gemini Commands to Agent System Migration Plan

## Overview
This document provides a comprehensive migration plan to convert existing .gemiflow4gemini/commands to the new agent-based system. Each command is mapped to an equivalent agent with defined roles, responsibilities, capabilities, and tool access restrictions.
...
**Command**: `.gemiflow4gemini/commands/coordination/init.md`
```yaml
---
role: coordinator
...
#### Agent Spawner
**Command**: `.gemiflow4gemini/commands/coordination/spawn.md`
```yaml
---
role: coordinator
name: Agent Spawner
...
tools:
  allowed:
    ...
    - mcp__gemiflow4gemini__daa_agent_create
    - mcp__gemiflow4gemini__agent_list
    - mcp__gemiflow4gemini__memory_usage
  restricted:
    - Bash
    - Write
...
#### Task Orchestrator
**Command**: `.gemiflow4gemini/commands/coordination/orchestrate.md`
```yaml
---
role: orchestrator
...
tools:
  allowed:
    ...
    - mcp__gemiflow4gemini__task_status
    - mcp__gemiflow4gemini__task_results
    - mcp__gemiflow4gemini__parallel_execute
    - TodoWrite
    - TodoRead
  restricted:
    - Bash
...
#### PR Manager Agent
**Command**: `.gemiflow4gemini/commands/github/pr-manager.md`
```yaml
---
...
**Command**: `.gemiflow4gemini/commands/github/code-review-swarm.md`
```yaml
---
role: reviewer
...
tools:
  allowed:
    ...
    - mcp__gemiflow4gemini__swarm_init
    - mcp__gemiflow4gemini__agent_spawn
    - mcp__gemiflow4gemini__github_code_review
    - mcp__gemiflow4gemini__memory_usage
  restricted:
    - Write
    - Edit
...
**Command**: `.gemiflow4gemini/commands/github/release-manager.md`
```yaml
---
...
tools:
  allowed:
    - Bash
    - Read
    - mcp__gemiflow4gemini__github_release_coord
    - mcp__gemiflow4gemini__swarm_init
    - mcp__gemiflow4gemini__task_orchestrate
    - TodoWrite
  restricted:
...
**Command**: `.gemiflow4gemini/commands/sparc/orchestrator.md`
```yaml
---
...
#### SPARC Coder Agent
**Command**: `.gemiflow4gemini/commands/sparc/coder.md`
```yaml
---
role: implementer
...
tools:
  allowed:
    ...
    - TodoWrite
  restricted:
    - mcp__gemiflow4gemini__swarm_init  # Focus on implementation
triggers:
...
#### SPARC Tester Agent
**Command**: `.gemiflow4gemini/commands/sparc/tester.md`
```yaml
---
...
**Command**: `.gemiflow4gemini/commands/analysis/performance-bottlenecks.md`
```yaml
---
role: analyst
...
tools:
  allowed:
    ...
    - mcp__gemiflow4gemini__metrics_collect
...
**Command**: `.gemiflow4gemini/commands/analysis/token-efficiency.md`
```yaml
---
role: analyst
...
tools:
  allowed:
    ...
    - mcp__gemiflow4gemini__usage_stats
    - mcp__gemiflow4gemini__memory_analytics
    - Read
  restricted:
    - Write
    - Edit
...
**Command**: `.gemiflow4gemini/commands/memory/usage.md`
```yaml
---
role: memory-manager
...
tools:
  allowed:
    ...
    - mcp__gemiflow4gemini__memory_namespace
    - mcp__gemiflow4gemini__memory_compress
    - mcp__gemiflow4gemini__memory_sync
  restricted:
    - Write
    - Edit
    - Bash
...
**Command**: `.gemiflow4gemini/commands/memory/neural.md`
```yaml
---
role: ai-specialist
...
tools:
  allowed:
    ...
    - mcp__gemiflow4gemini__neural_patterns
    - mcp__gemiflow4gemini__neural_predict
    - mcp__gemiflow4gemini__cognitive_analyze
    - mcp__gemiflow4gemini__learning_adapt
  restricted:
    - Write
    - Edit
    - Bash
...
**Command**: `.gemiflow4gemini/commands/automation/smart-agents.md`
```yaml
---
...
tools:
  allowed:
    - mcp__gemiflow4gemini__daa_agent_create
    - mcp__gemiflow4gemini__daa_capability_match
    - mcp__gemiflow4gemini__daa_resource_alloc
    - mcp__gemiflow4gemini__swarm_scale
...
**Command**: `.gemiflow4gemini/commands/automation/self-healing.md`
```yaml
---
...
tools:
  allowed:
    ...
    - mcp__gemiflow4gemini__error_analysis
    - mcp__gemiflow4gemini__diagnostic_run
...
**Command**: `.gemiflow4gemini/commands/optimization/parallel-execution.md`
```yaml
---
role: optimizer
...
tools:
  allowed:
    ...
    - mcp__gemiflow4gemini__batch_process
    - mcp__gemiflow4gemini__performance_report
    - TodoWrite
  restricted:
    - Write
...
**Command**: `.gemiflow4gemini/commands/optimization/auto-topology.md`
```yaml
---
role: optimizer
...
tools:
  allowed:
    ...
    - mcp__gemiflow4gemini__coordination_sync
...
#### Swarm Monitor Agent
**Command**: `.gemiflow4gemini/commands/monitoring/status.md`
```yaml
---
role: monitor
...
### 4. Migration Steps
1. Create `.gemiflow4gemini/agents/` directory structure
