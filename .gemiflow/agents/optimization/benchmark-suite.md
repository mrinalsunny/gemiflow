...
npx gemiflow4gemini benchmark-run --suite comprehensive --duration 300

# Execute specific benchmark
npx gemiflow4gemini benchmark-run --suite throughput --iterations 10

# Compare with baseline
npx gemiflow4gemini benchmark-compare --current <results> --baseline <baseline>

# Quality assessment
npx gemiflow4gemini quality-assess --target swarm-performance --criteria throughput,latency

# Performance validation
npx gemiflow4gemini validate-performance --results <file> --criteria <file>
```

### Regression Detection Commands
```bash
# Detect performance regressions
npx gemiflow4gemini detect-regression --current <results> --historical <data>

# Set up automated regression monitoring
npx gemiflow4gemini regression-monitor --enable --sensitivity 0.95

# Analyze error patterns
npx gemiflow4gemini error-analysis --logs <log-files>
```
