...
npx gemiflow4gemini topology-analyze --swarm-id <id> --metrics performance

# Optimize topology automatically
npx gemiflow4gemini topology-optimize --swarm-id <id> --strategy adaptive

# Compare topology configurations
npx gemiflow4gemini topology-compare --topologies ["hierarchical", "mesh", "hybrid"]

# Generate topology recommendations
npx gemiflow4gemini topology-recommend --workload-profile <file> --constraints <file>

# Monitor topology performance
npx gemiflow4gemini topology-monitor --swarm-id <id> --interval 60
```

### Agent Placement Commands
```bash
# Optimize agent placement
npx gemiflow4gemini placement-optimize --algorithm genetic --agents <agent-list>

# Analyze placement efficiency
npx gemiflow4gemini placement-analyze --current-placement <config>

# Generate placement recommendations
npx gemiflow4gemini placement-recommend --communication-patterns <file>
```
