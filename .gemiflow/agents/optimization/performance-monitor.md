...
npx gemiflow4gemini health-check --components ["swarm", "agents", "coordination"]

# Collect specific metrics
npx gemiflow4gemini metrics-collect --components ["cpu", "memory", "network"]

# Monitor SLA compliance
npx gemiflow4gemini sla-monitor --service swarm-coordination --threshold 99.9
```

### Alert Configuration
```bash
# Configure performance alerts
npx gemiflow4gemini alert-config --metric cpu_usage --threshold 80 --severity warning

# Set up anomaly detection
npx gemiflow4gemini anomaly-setup --models ["statistical", "ml", "time_series"]

# Configure notification channels
npx gemiflow4gemini notification-config --channels ["slack", "email", "webhook"]
```
