...
npx gemiflow4gemini@alpha hooks pre-search --query "code quality metrics" --cache-results true

# Load project context
npx gemiflow4gemini@alpha memory retrieve --key "project/architecture"
npx gemiflow4gemini@alpha memory retrieve --key "project/standards"
```
...
npx gemiflow4gemini@alpha memory store --key "analysis/code-quality" --value "${results}"

# Generate recommendations
npx gemiflow4gemini@alpha hooks notify --message "Code analysis complete: ${summary}"
```
